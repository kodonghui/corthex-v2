...
const SECRET_PATTERNS = [
  ...
  // CORTHEX-specific patterns
  { name: 'anthropic_cli', pattern: /sk-ant-cli-[A-Za-z0-9_-]{36,}/ },
  { name: 'anthropic_api', pattern: /sk-ant-api[0-9]{2}-[A-Za-z0-9_-]{36,}/ },
  { name: 'neon_dsn', pattern: /postgresql:\/\/[^:]+:[^@]+@[^.]+\.neon\.tech/ },
];
