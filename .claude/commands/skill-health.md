...
```bash
ECC_ROOT="/home/ubuntu/corthex-v2/.claude/hooks/ecc"
node "$ECC_ROOT/skills-health.js" --dashboard
```
...
```bash
ECC_ROOT="/home/ubuntu/corthex-v2/.claude/hooks/ecc"
node "$ECC_ROOT/skills-health.js" --dashboard --panel failures
```
...
```bash
ECC_ROOT="/home/ubuntu/corthex-v2/.claude/hooks/ecc"
node "$ECC_ROOT/skills-health.js" --dashboard --json
```
