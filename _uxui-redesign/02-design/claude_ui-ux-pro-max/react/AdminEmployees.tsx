...
{/* GET /api/admin/employees — returns employee list with department, role, agent_count, cli_token_tier */}
  {/* Sidebar */}
  <aside className="w-60 min-w-[240px] bg-zinc-900 border-r border-zinc-800 flex flex-col fixed h-full z-20">
    ...
    <nav className="flex-1 overflow-y-auto p-2 space-y-0.5">
      ...
      <a href="/admin/employees" className="flex items-center gap-2.5 px-2 py-1.5 rounded-md bg-zinc-800 text-zinc-50 cursor-pointer text-sm"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>직원</a>
  ...
  <main className="ml-60 flex-1 flex flex-col min-h-screen overflow-y-auto">
    <div className="h-12 border-b border-zinc-800 flex items-center px-6 gap-3 sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 flex-shrink-0">
      <span className="text-sm font-medium text-zinc-50">직원 관리</span>
      <span className="text-zinc-700">·</span>
      <span className="text-xs text-zinc-500">18명 인간 직원</span>
      <div className="ml-auto flex items-center gap-2">
        <button className="text-xs bg-blue-600 hover:bg-blue-500 text-white px-3 py-1.5 rounded-md">+ 직원 초대</button>
      </div>
    </div>
    <div className="flex-1 p-6">
      ...
      <div className="flex items-center gap-3 mb-4">
        <div className="flex-1 relative">
          ...
          <input type="text" placeholder="직원 검색..." className="w-full bg-zinc-900 border border-zinc-800 rounded-md pl-9 pr-4 py-1.5 text-sm text-zinc-300 placeholder-zinc-600 focus:outline-none focus:border-zinc-600" />
        </div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-zinc-800">
              <th className="text-left px-4 py-3 text-xs font-medium text-zinc-500">직원</th>
              ...
              <th className="text-left px-4 py-3 text-xs font-medium text-zinc-500">역할</th>
              <th className="text-left px-4 py-3 text-xs font-medium text-zinc-500">관리 에이전트</th>
              <th className="text-left px-4 py-3 text-xs font-medium text-zinc-500">CLI 토큰</th>
          ...
          <tbody className="divide-y divide-zinc-800">
            <tr className="hover:bg-zinc-800/30">
              ...
              <td className="px-4 py-3 text-zinc-500 text-xs font-mono">minjun@corthex.ai</td>
              <td className="px-4 py-3 text-zinc-400">AI 전략실</td>
              <td className="px-4 py-3"><span className="px-2 py-0.5 rounded text-xs bg-blue-500/10 text-blue-400">팀장</span></td>
              <td className="px-4 py-3 font-mono text-xs text-zinc-400">14</td>
              <td className="px-4 py-3 text-xs text-zinc-400">Max 구독</td>
            ...
            <tr className="hover:bg-zinc-800/30">
              ...
              <td className="px-4 py-3 text-zinc-500 text-xs font-mono">suhyeon@corthex.ai</td>
              <td className="px-4 py-3 text-zinc-400">리서치팀</td>
              <td className="px-4 py-3"><span className="px-2 py-0.5 rounded text-xs bg-purple-500/10 text-purple-400">팀원</span></td>
              <td className="px-4 py-3 font-mono text-xs text-zinc-400">8</td>
              <td className="px-4 py-3 text-xs text-zinc-400">Pro 구독</td>
            ...
            <tr className="hover:bg-zinc-800/30">
              <td className="px-4 py-3">
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 bg-green-600 rounded-full flex items-center justify-center text-xs text-white font-medium">박</div>
                  <span className="text-zinc-200">박지훈</span>
                </div>
              </td>
              <td className="px-4 py-3 text-zinc-500 text-xs font-mono">jihun@corthex.ai</td>
              <td className="px-4 py-3 text-zinc-400">운영팀</td>
              <td className="px-4 py-3"><span className="px-2 py-0.5 rounded text-xs bg-blue-500/10 text-blue-400">팀장</span></td>
              <td className="px-4 py-3 font-mono text-xs text-zinc-400">7</td>
              <td className="px-4 py-3 text-xs text-zinc-400">Max 구독</td>
              <td className="px-4 py-3"><span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400">활성</span></td>
              <td className="px-4 py-3"><button className="text-xs text-blue-400 hover:text-blue-300">편집</button></td>
            </tr>
            <tr className="hover:bg-zinc-800/30">
              <td className="px-4 py-3">
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 bg-yellow-600 rounded-full flex items-center justify-center text-xs text-white font-medium">최</div>
                  <span className="text-zinc-200">최서연</span>
                </div>
              </td>
              <td className="px-4 py-3 text-zinc-500 text-xs font-mono">seoyeon@corthex.ai</td>
              <td className="px-4 py-3 text-zinc-400">보안팀</td>
              <td className="px-4 py-3"><span className="px-2 py-0.5 rounded text-xs bg-yellow-500/10 text-yellow-400">팀원</span></td>
              <td className="px-4 py-3 font-mono text-xs text-zinc-400">6</td>
              <td className="px-4 py-3 text-xs text-zinc-400">Pro 구독</td>
              <td className="px-4 py-3"><span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400">활성</span></td>
              <td className="px-4 py-3"><button className="text-xs text-blue-400 hover:text-blue-300">편집</button></td>
            </tr>
        ...
        <div className="px-4 py-3 border-t border-zinc-800 flex items-center justify-between">
          <span className="text-xs text-zinc-500">18명 직원 중 1-4 표시</span>
