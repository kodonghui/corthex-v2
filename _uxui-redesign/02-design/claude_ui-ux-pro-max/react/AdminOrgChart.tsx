...
{/* GET /api/admin/org-chart — returns hierarchy tree with employees, agents per department */}
  {/* Sidebar */}
  ...
  <main className="ml-60 flex-1 flex flex-col min-h-screen overflow-y-auto">
    <div className="h-12 border-b border-zinc-800 flex items-center px-6 gap-3 sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 flex-shrink-0">
      <span className="text-sm font-medium text-zinc-50">조직도</span>
      <span className="text-zinc-700">·</span>
      <span className="text-xs text-zinc-500">CORTHEX v2 조직 구조</span>
      <div className="ml-auto flex items-center gap-2">
        <button className="text-xs bg-zinc-800 hover:bg-zinc-700 text-zinc-300 px-3 py-1.5 rounded-md">PNG 내보내기</button>
      </div>
    </div>
    <div className="flex-1 p-6">

      <div className="flex items-center gap-3 mb-4 text-xs text-zinc-500">
        <span className="flex items-center gap-1"><span className="w-3 h-3 rounded-full bg-blue-500"></span>AI 에이전트</span>
        <span className="flex items-center gap-1"><span className="w-3 h-3 rounded-full bg-zinc-400"></span>인간 직원</span>
        <span className="flex items-center gap-1"><span className="w-3 h-3 border border-zinc-600 rounded"></span>부서</span>
      </div>

      <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6 overflow-auto">
        {/* Root */}
        <div className="flex flex-col items-center">
          <div className="bg-zinc-800 border border-zinc-700 rounded-lg px-5 py-2.5 text-sm font-medium text-zinc-200">CORTHEX v2</div>
          <div className="w-px h-6 bg-zinc-700"></div>

          {/* CEO row */}
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-zinc-400"></div>
            <div className="bg-zinc-800 border border-zinc-700 rounded-lg px-4 py-2 text-sm text-zinc-200">김대표 <span className="text-xs text-zinc-500">(CEO)</span></div>
          </div>
          <div className="w-px h-6 bg-zinc-700"></div>
          ...
          <div className="flex gap-12 items-start">
            {/* 전략실 */}
            <div className="flex flex-col items-center">
              <div className="border border-zinc-700 rounded-lg px-3 py-2 text-xs text-zinc-400 bg-zinc-800/50 mb-2">AI 전략실</div>
              <div className="space-y-1.5">
                <div className="flex items-center gap-2 bg-zinc-800 rounded-md px-3 py-1.5 border border-zinc-700">
                  <div className="w-2 h-2 rounded-full bg-zinc-400 flex-shrink-0"></div>
                  <span className="text-xs text-zinc-300">김민준 <span className="text-zinc-600">(팀장)</span></span>
                </div>
                <div className="flex items-center gap-2 bg-zinc-900 rounded-md px-3 py-1.5 border border-zinc-800">
                  <div className="w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></div>
                  <span className="text-xs text-zinc-400 font-mono">AGT-001</span>
                  <span className="text-xs text-zinc-500">퀀트마스터</span>
                </div>
                <div className="flex items-center gap-2 bg-zinc-900 rounded-md px-3 py-1.5 border border-zinc-800">
                  <div className="w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></div>
                  <span className="text-xs text-zinc-400 font-mono">AGT-004</span>
                  <span className="text-xs text-zinc-500">시그널헌터</span>
                </div>
                <div className="text-xs text-zinc-600 text-center">+ 12개 더</div>
              </div>
            </div>

            {/* 리서치팀 */}
            <div className="flex flex-col items-center">
              <div className="border border-zinc-700 rounded-lg px-3 py-2 text-xs text-zinc-400 bg-zinc-800/50 mb-2">리서치팀</div>
              <div className="space-y-1.5">
                <div className="flex items-center gap-2 bg-zinc-800 rounded-md px-3 py-1.5 border border-zinc-700">
                  <div className="w-2 h-2 rounded-full bg-zinc-400 flex-shrink-0"></div>
                  <span className="text-xs text-zinc-300">이수현 <span className="text-zinc-600">(팀원)</span></span>
                </div>
                <div className="flex items-center gap-2 bg-zinc-900 rounded-md px-3 py-1.5 border border-zinc-800">
                  <div className="w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></div>
                  <span className="text-xs text-zinc-400 font-mono">AGT-002</span>
                  <span className="text-xs text-zinc-500">뉴스스캐너</span>
                </div>
                <div className="text-xs text-zinc-600 text-center">+ 7개 더</div>
              </div>
            </div>

            {/* 운영팀 */}
            <div className="flex flex-col items-center">
              <div className="border border-zinc-700 rounded-lg px-3 py-2 text-xs text-zinc-400 bg-zinc-800/50 mb-2">운영팀</div>
              <div className="space-y-1.5">
                <div className="flex items-center gap-2 bg-zinc-800 rounded-md px-3 py-1.5 border border-zinc-700">
                  <div className="w-2 h-2 rounded-full bg-zinc-400 flex-shrink-0"></div>
                  <span className="text-xs text-zinc-300">박지훈 <span className="text-zinc-600">(팀장)</span></span>
                </div>
                <div className="flex items-center gap-2 bg-zinc-900 rounded-md px-3 py-1.5 border border-zinc-800">
                  <div className="w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></div>
                  <span className="text-xs text-zinc-400 font-mono">AGT-012</span>
                  <span className="text-xs text-zinc-500">데이터허브</span>
                </div>
                <div className="text-xs text-zinc-600 text-center">+ 6개 더</div>
              </div>
            </div>

            {/* 보안팀 */}
            <div className="flex flex-col items-center">
              <div className="border border-zinc-700 rounded-lg px-3 py-2 text-xs text-zinc-400 bg-zinc-800/50 mb-2">보안팀</div>
              <div className="space-y-1.5">
                <div className="flex items-center gap-2 bg-zinc-800 rounded-md px-3 py-1.5 border border-zinc-700">
                  <div className="w-2 h-2 rounded-full bg-zinc-400 flex-shrink-0"></div>
                  <span className="text-xs text-zinc-300">최서연 <span className="text-zinc-600">(팀원)</span></span>
                </div>
                <div className="flex items-center gap-2 bg-zinc-900 rounded-md px-3 py-1.5 border border-zinc-800">
                  <div className="w-2 h-2 rounded-full bg-blue-500 flex-shrink-0"></div>
                  <span className="text-xs text-zinc-400 font-mono">AGT-003</span>
                  <span className="text-xs text-zinc-500">리스크가드</span>
                </div>
                <div className="text-xs text-zinc-600 text-center">+ 5개 더</div>
              </div>
            </div>
          </div>
        </div>
