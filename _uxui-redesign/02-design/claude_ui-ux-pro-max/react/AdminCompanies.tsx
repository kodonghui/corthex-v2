...
function AdminCompanies() {
  return (
    <>      
      ...
      {/* GET /api/admin/companies — returns company list with plan, agent_count, employee_count, contract_end */}
  {/* Sidebar */}
  <aside className="w-60 min-w-[240px] bg-zinc-900 border-r border-zinc-800 flex flex-col fixed h-full z-20">
    ...
    <nav className="flex-1 overflow-y-auto p-2 space-y-0.5">
      ...
      <a href="/admin/companies" className="flex items-center gap-2.5 px-2 py-1.5 rounded-md bg-zinc-800 text-zinc-50 cursor-pointer text-sm"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>회사</a>
  ...
  <main className="ml-60 flex-1 flex flex-col min-h-screen overflow-y-auto">
    <div className="h-12 border-b border-zinc-800 flex items-center px-6 gap-3 sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 flex-shrink-0">
      <span className="text-sm font-medium text-zinc-50">회사 관리</span>
      <span className="text-zinc-700">·</span>
      <span className="text-xs text-zinc-500">멀티 테넌트 회사 목록</span>
      <div className="ml-auto flex items-center gap-2">
        <button className="text-xs bg-blue-600 hover:bg-blue-500 text-white px-3 py-1.5 rounded-md">+ 회사 추가</button>
      </div>
    </div>
    <div className="flex-1 p-6">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="text-xs text-zinc-500 mb-1">등록 회사</div>
          <div className="text-2xl font-semibold font-mono">3</div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="text-xs text-zinc-500 mb-1">활성 플랜</div>
          <div className="text-2xl font-semibold font-mono">Enterprise</div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="text-xs text-zinc-500 mb-1">계약 만료</div>
          <div className="text-2xl font-semibold font-mono text-zinc-400">2027-01-15</div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center text-white font-bold text-sm">C</div>
              <div>
                <div className="text-sm font-semibold text-zinc-200">CORTHEX AI (주)</div>
                <div className="text-xs text-zinc-500 font-mono">corp-001 · 서울 강남구</div>
              </div>
            </div>
            <span className="px-2 py-0.5 rounded text-xs bg-blue-500/10 text-blue-400">Enterprise</span>
          </div>
          <div className="grid grid-cols-4 gap-4 text-xs">
            <div>
              <div className="text-zinc-600">활성 에이전트</div>
              <div className="text-zinc-300 font-mono mt-0.5">42</div>
            </div>
            <div>
              <div className="text-zinc-600">직원 수</div>
              <div className="text-zinc-300 font-mono mt-0.5">18명</div>
            </div>
            <div>
              <div className="text-zinc-600">월 한도</div>
              <div className="text-zinc-300 font-mono mt-0.5">₩8,000K</div>
            </div>
            <div>
              <div className="text-zinc-600">계약 만료</div>
              <div className="text-zinc-300 font-mono mt-0.5">2027-01-15</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-green-600 rounded-lg flex items-center justify-center text-white font-bold text-sm">K</div>
              <div>
                <div className="text-sm font-semibold text-zinc-200">KIS 증권 테스트</div>
                <div className="text-xs text-zinc-500 font-mono">corp-002 · 파트너사</div>
              </div>
            </div>
            <span className="px-2 py-0.5 rounded text-xs bg-green-500/10 text-green-400">Pro</span>
          </div>
          <div className="grid grid-cols-4 gap-4 text-xs">
            <div>
              <div className="text-zinc-600">활성 에이전트</div>
              <div className="text-zinc-300 font-mono mt-0.5">7</div>
            </div>
            <div>
              <div className="text-zinc-600">직원 수</div>
              <div className="text-zinc-300 font-mono mt-0.5">4명</div>
            </div>
            <div>
              <div className="text-zinc-600">월 한도</div>
              <div className="text-zinc-300 font-mono mt-0.5">₩2,000K</div>
            </div>
            <div>
              <div className="text-zinc-600">계약 만료</div>
              <div className="text-zinc-300 font-mono mt-0.5">2026-12-31</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 opacity-60">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-zinc-700 rounded-lg flex items-center justify-center text-white font-bold text-sm">T</div>
              <div>
                <div className="text-sm font-semibold text-zinc-300">테스트 워크스페이스</div>
                <div className="text-xs text-zinc-600 font-mono">corp-003 · 내부 테스트</div>
              </div>
            </div>
            <span className="px-2 py-0.5 rounded text-xs bg-zinc-700 text-zinc-500">Trial</span>
          </div>
          <div className="grid grid-cols-4 gap-4 text-xs">
            <div>
              <div className="text-zinc-600">활성 에이전트</div>
              <div className="text-zinc-500 font-mono mt-0.5">2</div>
            </div>
            <div>
              <div className="text-zinc-600">직원 수</div>
              <div className="text-zinc-500 font-mono mt-0.5">1명</div>
            </div>
            <div>
              <div className="text-zinc-600">월 한도</div>
              <div className="text-zinc-500 font-mono mt-0.5">₩100K</div>
            </div>
            <div>
              <div className="text-zinc-600">계약 만료</div>
              <div className="text-zinc-500 font-mono mt-0.5">2026-03-31</div>
            </div>
          </div>
        </div>
      </div>
