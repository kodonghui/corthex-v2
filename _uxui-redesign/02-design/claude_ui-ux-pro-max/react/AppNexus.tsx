...
function AppNexus() {
  ...
  <aside className="w-60 min-w-[240px] bg-zinc-900 border-r border-zinc-800 flex flex-col fixed h-full z-20">
    ...
    <nav className="flex-1 overflow-y-auto p-2 space-y-0.5">
      ...
      <a href="/app/nexus" className="flex items-center gap-2.5 px-2 py-1.5 rounded-md bg-zinc-800 text-zinc-50 cursor-pointer text-sm"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"/></svg>넥서스</a>
  ...
  <main className="ml-60 flex-1 flex flex-col min-h-screen overflow-y-auto">
    <div className="h-12 border-b border-zinc-800 flex items-center px-6 gap-3 sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 flex-shrink-0">
      <span className="text-sm font-medium text-zinc-50">넥서스</span>
      <span className="text-zinc-700">·</span>
      <span className="text-xs text-zinc-500">SketchVibe 캔버스 · 조직 시각화</span>
      <div className="ml-auto flex items-center gap-2">
        <button className="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 text-xs font-medium px-3 py-1.5 rounded-md transition-colors cursor-pointer">내보내기</button>
      </div>
    </div>
    <div className="flex-1 p-6">
      <div className="flex h-[calc(100vh-112px)] gap-0 bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
        {/* Left toolbar */}
        <div className="w-12 border-r border-zinc-800 flex flex-col items-center py-3 gap-2 bg-zinc-900 flex-shrink-0">
          <button className="w-8 h-8 rounded-md bg-blue-500/20 border border-blue-500/40 flex items-center justify-center cursor-pointer" title="선택">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2"><path d="M3 3l7.07 16.97 2.51-7.39 7.39-2.51L3 3z"/></svg>
          </button>
          <button className="w-8 h-8 rounded-md hover:bg-zinc-800 flex items-center justify-center cursor-pointer text-zinc-500 hover:text-zinc-300 transition-colors" title="연결">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
          </button>
          <button className="w-8 h-8 rounded-md hover:bg-zinc-800 flex items-center justify-center cursor-pointer text-zinc-500 hover:text-zinc-300 transition-colors" title="노드 추가">
          ...
          <div className="w-6 border-t border-zinc-800 my-1"></div>
          <button className="w-8 h-8 rounded-md hover:bg-zinc-800 flex items-center justify-center cursor-pointer text-zinc-500 hover:text-zinc-300 transition-colors" title="확대">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35M11 8v6m-3-3h6"/></svg>
          </button>
          <button className="w-8 h-8 rounded-md hover:bg-zinc-800 flex items-center justify-center cursor-pointer text-zinc-500 hover:text-zinc-300 transition-colors" title="축소">
        ...
        <div className="flex-1 relative bg-zinc-950 overflow-hidden" style={{"backgroundImage":"radial-gradient(circle, #3f3f46 1px, transparent 1px)","backgroundSize":"24px 24px"}}>
          ...
          <svg className="absolute inset-0 w-full h-full" style={{"overflow":"visible"}}>
            ...
            <line x1="420" y1="80" x2="640" y2="180" stroke="#3f3f46" strokeWidth="1.5"/>
            <line x1="200" y1="240" x2="120" y2="340" stroke="#3f3f46" strokeWidth="1"/>
            <line x1="200" y1="240" x2="280" y2="340" stroke="#3f3f46" strokeWidth="1"/>
            <line x1="640" y1="240" x2="560" y2="340" stroke="#3f3f46" strokeWidth="1"/>
            <line x1="640" y1="240" x2="720" y2="340" stroke="#3f3f46" strokeWidth="1"/>

            {/* CEO node */}
            <rect x="355" y="40" width="130" height="50" rx="8" fill="#18181b" stroke="#3b82f6" strokeWidth="1.5"/>
            <text x="420" y="60" fill="#fafafa" font-size="11" font-family="Inter" text-anchor="middle" font-weight="600">김대표</text>
            <text x="420" y="76" fill="#71717a" font-size="9" font-family="Inter" text-anchor="middle">CEO</text>

            {/* 비서실장 */}
            <rect x="355" y="170" width="130" height="50" rx="8" fill="#18181b" stroke="#3b82f6" strokeWidth="1.5"/>
            <text x="420" y="190" fill="#93c5fd" font-size="11" font-family="Inter" text-anchor="middle" font-weight="600">비서실장</text>
            <text x="420" y="206" fill="#71717a" font-size="9" font-family="Inter" text-anchor="middle">Manager · 비서실</text>

            {/* 전략팀장 */}
            <rect x="135" y="170" width="130" height="50" rx="8" fill="#18181b" stroke="#27272a" strokeWidth="1.5"/>
            <text x="200" y="190" fill="#d4d4d8" font-size="11" font-family="Inter" text-anchor="middle" font-weight="600">전략팀장</text>
            <text x="200" y="206" fill="#71717a" font-size="9" font-family="Inter" text-anchor="middle">Manager · 전략기획부</text>

            {/* 마케팅팀장 */}
            <rect x="575" y="170" width="130" height="50" rx="8" fill="#18181b" stroke="#27272a" strokeWidth="1.5"/>
            <text x="640" y="190" fill="#d4d4d8" font-size="11" font-family="Inter" text-anchor="middle" font-weight="600">마케팅팀장</text>
            <text x="640" y="206" fill="#71717a" font-size="9" font-family="Inter" text-anchor="middle">Manager · 마케팅부</text>

            {/* Specialists */}
            <rect x="55" y="320" width="130" height="50" rx="8" fill="#18181b" stroke="#27272a" strokeWidth="1"/>
            <text x="120" y="340" fill="#a1a1aa" font-size="10" font-family="Inter" text-anchor="middle">전략분석가</text>
            <text x="120" y="356" fill="#52525b" font-size="9" font-family="Inter" text-anchor="middle">Specialist</text>

            <rect x="215" y="320" width="130" height="50" rx="8" fill="#18181b" stroke="#27272a" strokeWidth="1"/>
            <text x="280" y="340" fill="#a1a1aa" font-size="10" font-family="Inter" text-anchor="middle">리서치봇</text>
            <text x="280" y="356" fill="#52525b" font-size="9" font-family="Inter" text-anchor="middle">Specialist</text>

            <rect x="495" y="320" width="130" height="50" rx="8" fill="#18181b" stroke="#27272a" strokeWidth="1"/>
            <text x="560" y="340" fill="#a1a1aa" font-size="10" font-family="Inter" text-anchor="middle">마케팅봇</text>
            <text x="560" y="356" fill="#52525b" font-size="9" font-family="Inter" text-anchor="middle">Specialist</text>

            <rect x="655" y="320" width="130" height="50" rx="8" fill="#18181b" stroke="#27272a" strokeWidth="1"/>
            <text x="720" y="340" fill="#a1a1aa" font-size="10" font-family="Inter" text-anchor="middle">SNS봇</text>
            <text x="720" y="356" fill="#52525b" font-size="9" font-family="Inter" text-anchor="middle">Worker</text>
          </svg>

          {/* Canvas controls */}
          <div className="absolute bottom-4 right-4 flex items-center gap-2">
            <button className="w-8 h-8 bg-zinc-800 border border-zinc-700 rounded-md flex items-center justify-center cursor-pointer hover:bg-zinc-700 transition-colors text-zinc-400">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 21l-4.35-4.35M11 8v6m-3-3h6M17 11a6 6 0 11-12 0 6 6 0 0112 0z"/></svg>
            </button>
            <button className="w-8 h-8 bg-zinc-800 border border-zinc-700 rounded-md flex items-center justify-center cursor-pointer hover:bg-zinc-700 transition-colors text-zinc-400">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35M8 11h6"/></svg>
            </button>
            <span className="text-xs text-zinc-500 bg-zinc-800 border border-zinc-700 px-2 py-1 rounded font-mono">75%</span>
          </div>
        </div>

        {/* Right properties panel */}
        <div className="w-56 border-l border-zinc-800 flex flex-col bg-zinc-900 flex-shrink-0">
          <div className="px-4 py-3 border-b border-zinc-800">
            <span className="text-xs font-medium text-zinc-400">선택된 노드</span>
          </div>
          <div className="p-4 space-y-3">
            <div>
              <div className="text-xs text-zinc-600 mb-1">이름</div>
              <div className="text-sm font-medium text-zinc-50">비서실장</div>
            </div>
            <div>
              <div className="text-xs text-zinc-600 mb-1">계급</div>
              <span className="px-2 py-0.5 rounded-full text-xs bg-blue-500/10 text-blue-400">Manager</span>
            </div>
            <div>
              <div className="text-xs text-zinc-600 mb-1">부서</div>
              <div className="text-sm text-zinc-300">비서실</div>
            </div>
            <div>
              <div className="text-xs text-zinc-600 mb-1">모델</div>
              <div className="text-xs font-mono text-zinc-400">claude-sonnet-4-6</div>
            </div>
            <div>
              <div className="text-xs text-zinc-600 mb-1">보고 대상</div>
              <div className="text-sm text-zinc-300">김대표 (CEO)</div>
            </div>
            <div className="pt-2 border-t border-zinc-800">
              <button className="w-full text-xs text-blue-400 hover:text-blue-300 text-left transition-colors cursor-pointer">에이전트 편집 →</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
        <button className="w-full flex items-center justify-between px-4 py-2.5 hover:bg-zinc-800/50 transition-colors cursor-pointer">
          <span className="text-xs font-medium text-zinc-400">Mermaid 코드</span>
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#71717a" strokeWidth="2"><path d="M19 9l-7 7-7-7"/></svg>
        </button>
        <div className="px-4 py-3 border-t border-zinc-800 bg-zinc-950 font-mono text-xs text-zinc-400">
          graph TD<br/>
          &nbsp;&nbsp;A[김대표 CEO] --> B[비서실장 Manager]<br/>
          &nbsp;&nbsp;B --> C[전략팀장 Manager]<br/>
          &nbsp;&nbsp;B --> D[마케팅팀장 Manager]<br/>
          &nbsp;&nbsp;C --> E[전략분석가 Specialist]<br/>
          &nbsp;&nbsp;C --> F[리서치봇 Specialist]<br/>
          &nbsp;&nbsp;D --> G[마케팅봇 Specialist]<br/>
          &nbsp;&nbsp;D --> H[SNS봇 Worker]
        </div>
      </div>
    </div>
