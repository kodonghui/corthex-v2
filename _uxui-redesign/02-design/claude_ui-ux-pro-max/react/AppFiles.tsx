...
{/* API: GET /api/files, POST /api/files/upload, DELETE /api/files/:id */}
  {/* Sidebar */}
  <aside className="w-60 min-w-[240px] bg-zinc-900 border-r border-zinc-800 flex flex-col fixed h-full z-20">
    ...
    <nav className="flex-1 overflow-y-auto p-2 space-y-0.5">
      ...
      <a href="/app/files" className="flex items-center gap-2.5 px-2 py-1.5 rounded-md bg-zinc-800 text-zinc-50 cursor-pointer text-sm"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"/></svg>파일</a>
  ...
  <main className="ml-60 flex-1 flex flex-col min-h-screen overflow-y-auto">
    <div className="h-12 border-b border-zinc-800 flex items-center px-6 gap-3 sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 flex-shrink-0">
      <span className="text-sm font-medium text-zinc-50">파일</span>
      <span className="text-zinc-700">·</span>
      <span className="text-xs text-zinc-500">파일 관리</span>
    ...
    <div className="flex-1 p-6">
      ...
      <div className="flex items-center gap-3 mb-5">
        <div className="flex items-center gap-1 text-xs text-zinc-500">
          <span className="hover:text-zinc-300 cursor-pointer transition-colors">루트</span>
          <span>/</span>
          <span className="hover:text-zinc-300 cursor-pointer transition-colors">보고서</span>
          <span>/</span>
          <span className="text-zinc-300">2026</span>
        </div>
        <div className="ml-auto flex items-center gap-2">
          <button className="p-1.5 rounded-md hover:bg-zinc-800 text-zinc-500 hover:text-zinc-300 transition-colors cursor-pointer">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
          </button>
          <button className="p-1.5 rounded-md bg-zinc-800 text-zinc-300 cursor-pointer">
      ...
      {/* Upload zone */}
      <div className="border-2 border-dashed border-zinc-700 rounded-lg p-6 mb-5 text-center hover:border-zinc-500 transition-colors cursor-pointer">
        <svg className="mx-auto mb-2" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#71717a" strokeWidth="1.5"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
        <p className="text-sm text-zinc-500">파일을 여기에 드래그하거나 <span className="text-blue-400 hover:text-blue-300">클릭</span>하여 업로드</p>
        <p className="text-xs text-zinc-600 mt-1">최대 100MB · PDF, XLSX, DOCX, JSON, CSV</p>
      </div>

      {/* Folders */}
      <div className="mb-4">
        <div className="text-xs font-medium text-zinc-500 mb-2">폴더</div>
        <div className="grid grid-cols-4 gap-3">
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-3 hover:border-zinc-700 cursor-pointer transition-colors flex items-center gap-3">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#eab308" strokeWidth="1.5"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
            <div>
              <div className="text-xs font-medium text-zinc-300">보고서/2026</div>
              <div className="text-xs text-zinc-600">34개 파일</div>
            </div>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-3 hover:border-zinc-700 cursor-pointer transition-colors flex items-center gap-3">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#eab308" strokeWidth="1.5"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
            <div>
              <div className="text-xs font-medium text-zinc-300">학습자료</div>
              <div className="text-xs text-zinc-600">12개 파일</div>
            </div>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-3 hover:border-zinc-700 cursor-pointer transition-colors flex items-center gap-3">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#eab308" strokeWidth="1.5"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
            <div>
              <div className="text-xs font-medium text-zinc-300">크롤링결과</div>
              <div className="text-xs text-zinc-600">89개 파일</div>
            </div>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-3 hover:border-zinc-700 cursor-pointer transition-colors flex items-center gap-3">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#eab308" strokeWidth="1.5"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
            <div>
              <div className="text-xs font-medium text-zinc-300">SNS자료</div>
              <div className="text-xs text-zinc-600">23개 파일</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
        <div className="px-4 py-2.5 border-b border-zinc-800">
          <span className="text-xs font-medium text-zinc-400">최근 파일</span>
        </div>
        <table className="w-full">
          <thead><tr className="border-b border-zinc-800">
            <th className="text-left py-2.5 px-4 text-xs font-medium text-zinc-500">파일명</th>
            <th className="text-left py-2.5 px-4 text-xs font-medium text-zinc-500">업로더</th>
            <th className="text-left py-2.5 px-4 text-xs font-medium text-zinc-500">수정일</th>
            <th className="text-right py-2.5 px-4 text-xs font-medium text-zinc-500">크기</th>
          ...
          <tbody>
            <tr className="border-b border-zinc-800/50 hover:bg-zinc-800/20 cursor-pointer transition-colors">
              <td className="py-2.5 px-4">
                <div className="flex items-center gap-2">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ef4444" strokeWidth="1.5"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                  <span className="text-sm text-zinc-300">report_2026-03-10.pdf</span>
                </div>
              </td>
              <td className="py-2.5 px-4 text-xs text-zinc-500">전략분석가</td>
              <td className="py-2.5 px-4 text-xs font-mono text-zinc-600">2026-03-10</td>
              <td className="py-2.5 px-4 text-right text-xs font-mono text-zinc-500">2.3 MB</td>
              <td className="py-2.5 px-4 text-right">
                <button className="text-xs text-zinc-500 hover:text-zinc-300 transition-colors cursor-pointer">다운로드</button>
              </td>
            </tr>
            <tr className="border-b border-zinc-800/50 hover:bg-zinc-800/20 cursor-pointer transition-colors">
              <td className="py-2.5 px-4">
                <div className="flex items-center gap-2">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="1.5"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                  <span className="text-sm text-zinc-300">analysis_q1_2026.xlsx</span>
                </div>
              </td>
              <td className="py-2.5 px-4 text-xs text-zinc-500">CIO봇</td>
              <td className="py-2.5 px-4 text-xs font-mono text-zinc-600">2026-03-09</td>
              <td className="py-2.5 px-4 text-right text-xs font-mono text-zinc-500">847 KB</td>
              <td className="py-2.5 px-4 text-right">
                <button className="text-xs text-zinc-500 hover:text-zinc-300 transition-colors cursor-pointer">다운로드</button>
              </td>
            </tr>
            <tr className="border-b border-zinc-800/50 hover:bg-zinc-800/20 cursor-pointer transition-colors">
              <td className="py-2.5 px-4">
                <div className="flex items-center gap-2">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="1.5"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                  <span className="text-sm text-zinc-300">training_data_v3.json</span>
                </div>
              </td>
              <td className="py-2.5 px-4 text-xs text-zinc-500">김대표</td>
              <td className="py-2.5 px-4 text-xs font-mono text-zinc-600">2026-03-08</td>
              <td className="py-2.5 px-4 text-right text-xs font-mono text-zinc-500">12.1 MB</td>
              <td className="py-2.5 px-4 text-right">
                <button className="text-xs text-zinc-500 hover:text-zinc-300 transition-colors cursor-pointer">다운로드</button>
              </td>
            </tr>
            <tr className="hover:bg-zinc-800/20 cursor-pointer transition-colors">
              <td className="py-2.5 px-4">
                <div className="flex items-center gap-2">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#eab308" strokeWidth="1.5"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                  <span className="text-sm text-zinc-300">competitor_crawl_20260309.csv</span>
                </div>
              </td>
              <td className="py-2.5 px-4 text-xs text-zinc-500">리서치봇</td>
              <td className="py-2.5 px-4 text-xs font-mono text-zinc-600">2026-03-09</td>
              <td className="py-2.5 px-4 text-right text-xs font-mono text-zinc-500">3.4 MB</td>
              <td className="py-2.5 px-4 text-right">
                <button className="text-xs text-zinc-500 hover:text-zinc-300 transition-colors cursor-pointer">다운로드</button>
              </td>
            </tr>
