...
{/* API: GET /api/commands, POST /api/commands, WS /ws (streaming) */}
  {/* Sidebar */}
  <aside className="w-60 min-w-[240px] bg-zinc-900 border-r border-zinc-800 flex flex-col fixed h-full z-20">
    ...
    <nav className="flex-1 overflow-y-auto p-2 space-y-0.5">
      ...
      <a href="/app/command-center" className="flex items-center gap-2.5 px-2 py-1.5 rounded-md bg-zinc-800 text-zinc-50 cursor-pointer text-sm"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M13 10V3L4 14h7v7l9-11h-7"/></svg>사령관실</a>
  ...
  <main className="ml-60 flex-1 flex flex-col min-h-screen overflow-y-auto">
    <div className="h-12 border-b border-zinc-800 flex items-center px-6 gap-3 sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 flex-shrink-0">
      <span className="text-sm font-medium text-zinc-50">사령관실</span>
      <span className="text-zinc-700">·</span>
      <span className="text-xs text-zinc-500">AI 명령 & 위임 체인</span>
      <div className="ml-auto flex items-center gap-2">
        <button className="bg-blue-500 hover:bg-blue-600 text-white text-xs font-medium px-3 py-1.5 rounded-md transition-colors cursor-pointer flex items-center gap-1.5"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M13 10V3L4 14h7v7l9-11h-7"/></svg>명령 실행</button>
      </div>
    </div>
    <div className="flex-1 p-6">
      {/* Command input bar (Raycast style) */}
      <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-4 mb-6 hover:border-zinc-600 transition-colors">
        <div className="flex items-center gap-3">
          ...
          <input className="flex-1 bg-transparent text-sm text-zinc-50 placeholder-zinc-600 focus:outline-none" placeholder="비서실장에게 명령하기..." />
          <div className="flex items-center gap-1.5">
            <span className="text-xs text-zinc-600 bg-zinc-800 px-1.5 py-0.5 rounded font-mono">⌘</span>
            <span className="text-xs text-zinc-600 bg-zinc-800 px-1.5 py-0.5 rounded font-mono">K</span>
          </div>
        </div>
        {/* Preset commands */}
        <div className="flex items-center gap-2 mt-3 pt-3 border-t border-zinc-800">
          <span className="text-xs text-zinc-600">빠른 명령:</span>
          <button className="text-xs text-zinc-400 bg-zinc-800 hover:bg-zinc-700 px-2.5 py-1 rounded transition-colors cursor-pointer">시장 브리핑 요청</button>
          <button className="text-xs text-zinc-400 bg-zinc-800 hover:bg-zinc-700 px-2.5 py-1 rounded transition-colors cursor-pointer">주간 보고서 작성</button>
          <button className="text-xs text-zinc-400 bg-zinc-800 hover:bg-zinc-700 px-2.5 py-1 rounded transition-colors cursor-pointer">경쟁사 분석 시작</button>
          <button className="text-xs text-zinc-400 bg-zinc-800 hover:bg-zinc-700 px-2.5 py-1 rounded transition-colors cursor-pointer">전략 토론 소집</button>
        </div>
      </div>

      {/* Recent commands */}
      <div className="mb-4">
        <h3 className="text-xs font-medium text-zinc-500 uppercase tracking-wider mb-2">최근 명령</h3>
        <div className="space-y-1.5">
          <div className="flex items-center gap-3 px-3 py-2 bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors cursor-pointer">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2"><path d="M13 10V3L4 14h7v7l9-11h-7"/></svg>
            <span className="text-sm text-zinc-300 flex-1">삼성전자 Q1 실적 기반으로 매수 전략 검토해줘</span>
            <span className="text-xs text-zinc-600">14분 전</span>
            <span className="px-2 py-0.5 rounded-full text-xs bg-blue-500/10 text-blue-400">실행중</span>
          </div>
          <div className="flex items-center gap-3 px-3 py-2 bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors cursor-pointer">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="2"><path d="M13 10V3L4 14h7v7l9-11h-7"/></svg>
            <span className="text-sm text-zinc-300 flex-1">이번 주 SNS 콘텐츠 캘린더 작성해줘</span>
            <span className="text-xs text-zinc-600">1시간 전</span>
            <span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400">완료</span>
          </div>
          <div className="flex items-center gap-3 px-3 py-2 bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors cursor-pointer">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="2"><path d="M13 10V3L4 14h7v7l9-11h-7"/></svg>
            <span className="text-sm text-zinc-300 flex-1">오늘 오전 시장 뉴스 요약 보고해줘</span>
            <span className="text-xs text-zinc-600">3시간 전</span>
            <span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400">완료</span>
          </div>
          <div className="flex items-center gap-3 px-3 py-2 bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors cursor-pointer">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="2"><path d="M13 10V3L4 14h7v7l9-11h-7"/></svg>
            <span className="text-sm text-zinc-300 flex-1">네이버 경쟁사 3곳 가격 변동 모니터링</span>
            <span className="text-xs text-zinc-600">어제</span>
            <span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400">완료</span>
          </div>
          <div className="flex items-center gap-3 px-3 py-2 bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors cursor-pointer">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#ef4444" strokeWidth="2"><path d="M13 10V3L4 14h7v7l9-11h-7"/></svg>
            <span className="text-sm text-zinc-300 flex-1">기술팀에 인프라 비용 절감 방안 분석 요청</span>
            <span className="text-xs text-zinc-600">어제</span>
            <span className="px-2 py-0.5 rounded-full text-xs bg-red-500/10 text-red-400">실패</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-5 gap-6">
        {/* Left 60%: 위임 체인 */}
        <div className="col-span-3 bg-zinc-900 border border-zinc-800 rounded-lg">
          <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800">
            <h3 className="text-sm font-semibold text-zinc-50">진행 중 위임 체인</h3>
            <span className="text-xs text-zinc-500">삼성전자 매수 전략 검토</span>
          </div>
          <div className="p-6">
            {/* Chain visualization */}
            <div className="flex flex-col items-center gap-0">
              ...
              <div className="flex items-center gap-3 w-full max-w-sm">
                <div className="w-8 h-8 bg-zinc-700 rounded-full flex items-center justify-center text-xs font-medium text-zinc-300">김</div>
                <div className="flex-1 bg-zinc-800 border border-zinc-700 rounded-lg px-3 py-2">
                  <div className="text-xs font-medium text-zinc-300">김대표 (CEO)</div>
                  <div className="text-xs text-zinc-600">명령 발신 · 14:18</div>
                </div>
              </div>
              <div className="w-px h-6 bg-zinc-700 ml-4"></div>
              {/* 비서실장 */}
              <div className="flex items-center gap-3 w-full max-w-sm">
                ...
                <div className="flex-1 bg-blue-500/5 border border-blue-500/20 rounded-lg px-3 py-2">
                  <div className="text-xs font-medium text-blue-300">비서실장 (Manager)</div>
                  <div className="text-xs text-zinc-600">전략팀 위임 중 · claude-sonnet-4-6</div>
                </div>
                <span className="px-2 py-0.5 rounded-full text-xs bg-orange-500/10 text-orange-400 flex-shrink-0 animate-pulse">●</span>
              </div>
              <div className="w-px h-6 bg-zinc-700 ml-4"></div>
              {/* 마케팅팀장 */}
              <div className="flex items-center gap-3 w-full max-w-sm ml-8">
                <div className="w-8 h-8 bg-blue-500/20 border border-blue-500/30 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2"><path d="M13 10V3L4 14h7v7l9-11h-7"/></svg>
                </div>
                <div className="flex-1 bg-zinc-800 border border-zinc-700 rounded-lg px-3 py-2">
                  <div className="text-xs font-medium text-zinc-300">전략팀장 (Manager)</div>
                  <div className="text-xs text-zinc-600">분석 위임 중 · claude-sonnet-4-6</div>
                </div>
                <span className="px-2 py-0.5 rounded-full text-xs bg-blue-500/10 text-blue-400 flex-shrink-0 animate-pulse">●</span>
              </div>
              <div className="w-px h-6 bg-zinc-700 ml-12"></div>
              {/* 전략분석가 */}
              <div className="flex items-center gap-3 w-full max-w-sm ml-16">
                ...
                <div className="flex-1 bg-purple-500/5 border border-purple-500/20 rounded-lg px-3 py-2">
                  <div className="text-xs font-medium text-purple-300">전략분석가 (Specialist)</div>
                  <div className="text-xs text-zinc-600">삼성전자 데이터 수집 중 · claude-haiku-3-5</div>
                </div>
                <span className="px-2 py-0.5 rounded-full text-xs bg-blue-500/10 text-blue-400 flex-shrink-0 animate-pulse">●</span>
              </div>
            </div>
        ...
        {/* Right 40%: 실시간 로그 */}
        <div className="col-span-2 bg-zinc-900 border border-zinc-800 rounded-lg flex flex-col">
          <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800 flex-shrink-0">
            <h3 className="text-sm font-semibold text-zinc-50">실시간 로그</h3>
            <span className="w-2 h-2 rounded-full bg-orange-400 animate-pulse"></span>
          </div>
          <div className="flex-1 overflow-y-auto p-3 space-y-1.5 font-mono text-xs">
            <div className="flex gap-2">
              <span className="text-zinc-600 flex-shrink-0">14:32:01</span>
              <span className="text-blue-400">[위임] 비서실장 → 전략팀장: 삼성전자 분석 요청</span>
            </div>
            <div className="flex gap-2">
              <span className="text-zinc-600 flex-shrink-0">14:32:04</span>
              <span className="text-blue-400">[위임] 전략팀장 → 전략분석가: 데이터 수집 지시</span>
            </div>
            <div className="flex gap-2">
              <span className="text-zinc-600 flex-shrink-0">14:32:09</span>
              <span className="text-zinc-400">[실행] 전략분석가: KIS API 시세 조회 시작</span>
            </div>
            <div className="flex gap-2">
              <span className="text-zinc-600 flex-shrink-0">14:32:15</span>
              <span className="text-zinc-400">[실행] 전략분석가: 뉴스 크롤링 도구 호출</span>
            </div>
            <div className="flex gap-2">
              <span className="text-zinc-600 flex-shrink-0">14:32:31</span>
              <span className="text-green-400">[완료] 전략분석가: 시세 데이터 수집 완료 (47종목)</span>
            </div>
            <div className="flex gap-2">
              <span className="text-zinc-600 flex-shrink-0">14:32:45</span>
              <span className="text-zinc-400">[실행] 전략분석가: DART 공시 데이터 파싱 중</span>
            </div>
            <div className="flex gap-2">
              <span className="text-zinc-600 flex-shrink-0">14:33:02</span>
              <span className="text-yellow-400">[경고] 전략분석가: API 응답 지연 (2.3s)</span>
            </div>
            <div className="flex gap-2">
              <span className="text-zinc-600 flex-shrink-0">14:33:18</span>
              <span className="text-green-400">[완료] 전략분석가: 공시 데이터 수집 완료</span>
            </div>
            <div className="flex gap-2">
              <span className="text-zinc-600 flex-shrink-0">14:33:22</span>
              <span className="text-zinc-400">[실행] 전략분석가: 분석 리포트 초안 작성 중...</span>
            </div>
          </div>
        </div>
      </div>
