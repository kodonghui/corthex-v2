...
{/* API: GET /api/knowledge, GET /api/knowledge/:id, POST /api/knowledge */}
  {/* Sidebar */}
  <aside className="w-60 min-w-[240px] bg-zinc-900 border-r border-zinc-800 flex flex-col fixed h-full z-20">
    ...
    <nav className="flex-1 overflow-y-auto p-2 space-y-0.5">
      ...
      <a href="/app/knowledge" className="flex items-center gap-2.5 px-2 py-1.5 rounded-md bg-zinc-800 text-zinc-50 cursor-pointer text-sm"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>지식창고</a>
  ...
  <main className="ml-60 flex-1 flex flex-col min-h-screen overflow-y-auto">
    <div className="h-12 border-b border-zinc-800 flex items-center px-6 gap-3 sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 flex-shrink-0">
      <span className="text-sm font-medium text-zinc-50">지식창고</span>
      <span className="text-zinc-700">·</span>
      <span className="text-xs text-zinc-500">문서 & 정책 관리</span>
    ...
    <div className="flex-1 p-6">
      ...
      <div className="flex items-center gap-3 mb-5">
        <div className="flex-1 relative">
          <svg className="absolute left-3 top-1/2 -translate-y-1/2" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#71717a" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
          <input className="w-full bg-zinc-900 border border-zinc-700 text-zinc-300 text-sm pl-9 pr-3 py-2 rounded-md placeholder-zinc-600 focus:outline-none focus:border-blue-500 transition-colors" placeholder="문서 검색..." />
        </div>
        <button className="bg-blue-500 hover:bg-blue-600 text-white text-xs font-medium px-3 py-2 rounded-md transition-colors cursor-pointer">+ 문서 추가</button>
      </div>

      <div className="flex gap-6 h-[calc(100vh-168px)]">
        {/* Left: folder tree */}
        <div className="w-56 flex-shrink-0 bg-zinc-900 border border-zinc-800 rounded-lg overflow-y-auto">
          <div className="px-3 py-2.5 border-b border-zinc-800">
            <span className="text-xs font-semibold text-zinc-400">폴더</span>
          </div>
          <div className="p-2 space-y-0.5">
            <div className="flex items-center gap-2 px-2 py-1.5 bg-zinc-800 rounded-md cursor-pointer">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
              <span className="text-xs text-zinc-50">회사 정책</span>
              <span className="ml-auto text-xs text-zinc-600">8</span>
            </div>
            <div className="flex items-center gap-2 px-2 py-1.5 rounded-md cursor-pointer hover:bg-zinc-800/50 transition-colors">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#71717a" strokeWidth="2"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
              <span className="text-xs text-zinc-400">투자 전략</span>
              <span className="ml-auto text-xs text-zinc-600">12</span>
            </div>
            <div className="flex items-center gap-2 px-2 py-1.5 rounded-md cursor-pointer hover:bg-zinc-800/50 transition-colors">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#71717a" strokeWidth="2"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
              <span className="text-xs text-zinc-400">마케팅 가이드</span>
              <span className="ml-auto text-xs text-zinc-600">6</span>
            </div>
            <div className="flex items-center gap-2 px-2 py-1.5 rounded-md cursor-pointer hover:bg-zinc-800/50 transition-colors">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#71717a" strokeWidth="2"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
              <span className="text-xs text-zinc-400">법무 문서</span>
              <span className="ml-auto text-xs text-zinc-600">4</span>
            </div>
            <div className="flex items-center gap-2 px-2 py-1.5 rounded-md cursor-pointer hover:bg-zinc-800/50 transition-colors">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#71717a" strokeWidth="2"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
              <span className="text-xs text-zinc-400">기술 문서</span>
              <span className="ml-auto text-xs text-zinc-600">9</span>
            </div>
          </div>
        </div>

        {/* Right: documents */}
        <div className="flex-1 bg-zinc-900 border border-zinc-800 rounded-lg overflow-y-auto">
          <div className="px-4 py-3 border-b border-zinc-800 flex items-center justify-between">
            <span className="text-sm font-semibold text-zinc-50">회사 정책 (8개)</span>
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 rounded-full text-xs bg-zinc-800 text-zinc-500 cursor-pointer hover:text-zinc-300 transition-colors">전체</span>
              <span className="px-2 py-0.5 rounded-full text-xs bg-zinc-800 text-zinc-500 cursor-pointer hover:text-zinc-300 transition-colors">#투자원칙</span>
              <span className="px-2 py-0.5 rounded-full text-xs bg-zinc-800 text-zinc-500 cursor-pointer hover:text-zinc-300 transition-colors">#보안</span>
            </div>
          </div>
          <div className="divide-y divide-zinc-800/50">
            <div className="px-4 py-3 hover:bg-zinc-800/30 cursor-pointer transition-colors">
              <div className="flex items-start gap-3">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#a855f7" strokeWidth="2" className="mt-0.5 flex-shrink-0"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <div className="flex-1">
                  <div className="text-sm font-medium text-zinc-300">AI 에이전트 운영 정책 v2.1</div>
                  <div className="text-xs text-zinc-600 mt-0.5">수정: 2026-02-15 · 에이전트 접근: 전체</div>
                </div>
                <div className="flex items-center gap-1.5">
                  <span className="px-1.5 py-0.5 rounded text-xs bg-zinc-800 text-zinc-500">#운영</span>
                </div>
              </div>
            </div>
            <div className="px-4 py-3 hover:bg-zinc-800/30 cursor-pointer transition-colors">
              <div className="flex items-start gap-3">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#a855f7" strokeWidth="2" className="mt-0.5 flex-shrink-0"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <div className="flex-1">
                  <div className="text-sm font-medium text-zinc-300">투자 리스크 관리 기준</div>
                  <div className="text-xs text-zinc-600 mt-0.5">수정: 2026-01-20 · 에이전트 접근: CIO봇, 전략팀</div>
                </div>
                <div className="flex items-center gap-1.5">
                  <span className="px-1.5 py-0.5 rounded text-xs bg-zinc-800 text-zinc-500">#투자원칙</span>
                </div>
              </div>
            </div>
            <div className="px-4 py-3 hover:bg-zinc-800/30 cursor-pointer transition-colors">
              <div className="flex items-start gap-3">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#a855f7" strokeWidth="2" className="mt-0.5 flex-shrink-0"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <div className="flex-1">
                  <div className="text-sm font-medium text-zinc-300">SNS 콘텐츠 가이드라인 2026</div>
                  <div className="text-xs text-zinc-600 mt-0.5">수정: 2026-01-05 · 에이전트 접근: 마케팅부 전체</div>
                </div>
                <div className="flex items-center gap-1.5">
                  <span className="px-1.5 py-0.5 rounded text-xs bg-zinc-800 text-zinc-500">#마케팅</span>
                </div>
              </div>
            </div>
            <div className="px-4 py-3 hover:bg-zinc-800/30 cursor-pointer transition-colors">
              <div className="flex items-start gap-3">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#a855f7" strokeWidth="2" className="mt-0.5 flex-shrink-0"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <div className="flex-1">
                  <div className="text-sm font-medium text-zinc-300">보안 정책 및 크리덴셜 관리 규정</div>
                  <div className="text-xs text-zinc-600 mt-0.5">수정: 2025-12-01 · 에이전트 접근: 비서실장만</div>
                </div>
                <div className="flex items-center gap-1.5">
                  <span className="px-1.5 py-0.5 rounded text-xs bg-zinc-800 text-zinc-500">#보안</span>
                </div>
              </div>
            </div>
          </div>
