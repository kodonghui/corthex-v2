...
{/* GET /api/admin/tools — returns tool list with call_count, error_rate, status */}
  {/* Sidebar */}
  <aside className="w-60 min-w-[240px] bg-zinc-900 border-r border-zinc-800 flex flex-col fixed h-full z-20">
    ...
    <nav className="flex-1 overflow-y-auto p-2 space-y-0.5">
      ...
      <a href="/admin/tools" className="flex items-center gap-2.5 px-2 py-1.5 rounded-md bg-zinc-800 text-zinc-50 cursor-pointer text-sm"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065zM15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>도구</a>
  ...
  <main className="ml-60 flex-1 flex flex-col min-h-screen overflow-y-auto">
    <div className="h-12 border-b border-zinc-800 flex items-center px-6 gap-3 sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 flex-shrink-0">
      <span className="text-sm font-medium text-zinc-50">도구 관리</span>
      <span className="text-zinc-700">·</span>
      <span className="text-xs text-zinc-500">31개 등록 도구</span>
      <div className="ml-auto flex items-center gap-2">
        <button className="text-xs bg-blue-600 hover:bg-blue-500 text-white px-3 py-1.5 rounded-md">+ 도구 등록</button>
      </div>
    </div>
    <div className="flex-1 p-6">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="text-xs text-zinc-500 mb-1">등록 도구</div>
          <div className="text-2xl font-semibold font-mono">31</div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="text-xs text-zinc-500 mb-1">활성 에이전트 연결</div>
          <div className="text-2xl font-semibold font-mono">127</div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="text-xs text-zinc-500 mb-1">오늘 도구 호출</div>
          <div className="text-2xl font-semibold font-mono">8,432</div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="text-xs text-zinc-500 mb-1">오류율</div>
          <div className="text-2xl font-semibold font-mono text-yellow-400">1.2%</div>
        </div>
      </div>

      <div className="grid grid-cols-3 gap-4">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
          <div className="px-4 py-3 border-b border-zinc-800"><span className="text-sm font-medium">금융/증권</span></div>
          <div className="divide-y divide-zinc-800">
            <div className="px-4 py-3 flex items-center justify-between">
              <div>
                <div className="text-sm text-zinc-200">KIS 주문 API</div>
                <div className="text-xs text-zinc-500 font-mono">kis_order_v2</div>
              </div>
              <div className="text-right">
                <div className="text-xs text-green-400">정상</div>
                <div className="text-xs text-zinc-600 font-mono">4,201 calls</div>
              </div>
            </div>
            <div className="px-4 py-3 flex items-center justify-between">
              <div>
                <div className="text-sm text-zinc-200">시장 데이터 조회</div>
                <div className="text-xs text-zinc-500 font-mono">market_data_v3</div>
              </div>
              <div className="text-right">
                <div className="text-xs text-green-400">정상</div>
                <div className="text-xs text-zinc-600 font-mono">2,847 calls</div>
              </div>
            </div>
            <div className="px-4 py-3 flex items-center justify-between">
              <div>
                <div className="text-sm text-zinc-200">포트폴리오 조회</div>
                <div className="text-xs text-zinc-500 font-mono">portfolio_read</div>
              </div>
              <div className="text-right">
                <div className="text-xs text-yellow-400">경고</div>
                <div className="text-xs text-zinc-600 font-mono">312 calls</div>
              </div>
            </div>
          </div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
          <div className="px-4 py-3 border-b border-zinc-800"><span className="text-sm font-medium">커뮤니케이션</span></div>
          <div className="divide-y divide-zinc-800">
            <div className="px-4 py-3 flex items-center justify-between">
              <div>
                <div className="text-sm text-zinc-200">Slack 메시지 전송</div>
                <div className="text-xs text-zinc-500 font-mono">slack_send_v1</div>
              </div>
              <div className="text-right">
                <div className="text-xs text-green-400">정상</div>
                <div className="text-xs text-zinc-600 font-mono">548 calls</div>
              </div>
            </div>
            <div className="px-4 py-3 flex items-center justify-between">
              <div>
                <div className="text-sm text-zinc-200">이메일 발송</div>
                <div className="text-xs text-zinc-500 font-mono">smtp_send</div>
              </div>
              <div className="text-right">
                <div className="text-xs text-green-400">정상</div>
                <div className="text-xs text-zinc-600 font-mono">124 calls</div>
              </div>
            </div>
          </div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
          <div className="px-4 py-3 border-b border-zinc-800"><span className="text-sm font-medium">데이터/AI</span></div>
          <div className="divide-y divide-zinc-800">
            <div className="px-4 py-3 flex items-center justify-between">
              <div>
                <div className="text-sm text-zinc-200">웹 스크래핑</div>
                <div className="text-xs text-zinc-500 font-mono">web_scrape_v2</div>
              </div>
              <div className="text-right">
                <div className="text-xs text-green-400">정상</div>
                <div className="text-xs text-zinc-600 font-mono">287 calls</div>
              </div>
            </div>
            <div className="px-4 py-3 flex items-center justify-between">
              <div>
                <div className="text-sm text-zinc-200">벡터 검색</div>
                <div className="text-xs text-zinc-500 font-mono">vector_search</div>
              </div>
              <div className="text-right">
                <div className="text-xs text-red-400">오류</div>
                <div className="text-xs text-zinc-600 font-mono">91 calls</div>
              </div>
            </div>
          </div>
        </div>
