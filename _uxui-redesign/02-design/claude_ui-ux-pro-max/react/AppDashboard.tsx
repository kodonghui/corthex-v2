...
function AppDashboard() {
  ...
  <aside className="w-60 min-w-[240px] bg-zinc-900 border-r border-zinc-800 flex flex-col fixed h-full z-20">
    ...
    <nav className="flex-1 overflow-y-auto p-2 space-y-0.5">
      ...
      <a href="/app/dashboard" className="flex items-center gap-2.5 px-2 py-1.5 rounded-md bg-zinc-800 text-zinc-50 cursor-pointer text-sm"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>대시보드</a>
  ...
  <main className="ml-60 flex-1 flex flex-col min-h-screen overflow-y-auto">
    <div className="h-12 border-b border-zinc-800 flex items-center px-6 gap-3 sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 flex-shrink-0">
      <span className="text-sm font-medium text-zinc-50">대시보드</span>
      <span className="text-zinc-700">·</span>
      <span className="text-xs text-zinc-500">분석 & 성과 현황</span>
      <div className="ml-auto flex items-center gap-2">
        <button className="text-xs text-zinc-400 hover:text-zinc-300 bg-zinc-800 hover:bg-zinc-700 px-3 py-1.5 rounded-md transition-colors cursor-pointer">기간 선택</button>
      </div>
    </div>
    <div className="flex-1 p-6">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 hover:border-zinc-700 transition-colors">
          <div className="flex items-center justify-between mb-3"><span className="text-xs text-zinc-500">총 명령 수</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#71717a" strokeWidth="2"><path d="M13 10V3L4 14h7v7l9-11h-7"/></svg></div>
          <div className="text-2xl font-semibold text-zinc-50">1,284</div>
          <div className="text-xs text-green-400 mt-1">+47 오늘</div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 hover:border-zinc-700 transition-colors">
          <div className="flex items-center justify-between mb-3"><span className="text-xs text-zinc-500">성공률</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#71717a" strokeWidth="2"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></div>
          <div className="text-2xl font-semibold text-zinc-50">97.2%</div>
          <div className="text-xs text-green-400 mt-1">+0.8% vs 지난 주</div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 hover:border-zinc-700 transition-colors">
          <div className="flex items-center justify-between mb-3"><span className="text-xs text-zinc-500">평균 응답시간</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#71717a" strokeWidth="2"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></div>
          <div className="text-2xl font-semibold text-zinc-50 font-mono">1m 42s</div>
          <div className="text-xs text-red-400 mt-1">+12s vs 지난 주</div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 hover:border-zinc-700 transition-colors">
          <div className="flex items-center justify-between mb-3"><span className="text-xs text-zinc-500">이번 달 비용</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#71717a" strokeWidth="2"><path d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></div>
          <div className="text-2xl font-semibold text-zinc-50 font-mono">$23.40</div>
          <div className="text-xs text-yellow-400 mt-1">예산 $30 중 78%</div>
        </div>
      </div>

      {/* Row 2: Charts */}
      <div className="grid grid-cols-3 gap-6 mb-6">
        {/* Command trend bar chart */}
        <div className="col-span-2 bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          ...
          <div className="flex items-center gap-4 mt-3 pt-3 border-t border-zinc-800">
            <span className="text-xs text-zinc-500">총 명령: <span className="text-zinc-300">312건</span></span>
            <span className="text-xs text-zinc-500">성공: <span className="text-green-400">304건</span></span>
            <span className="text-xs text-zinc-500">실패: <span className="text-red-400">8건</span></span>
          </div>
        </div>
        {/* Department cost donut */}
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <h3 className="text-sm font-semibold text-zinc-50 mb-4">부서별 비용</h3>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between"><div className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-blue-500"></span><span className="text-xs text-zinc-400">전략기획부</span></div><span className="text-xs font-mono text-zinc-300">$8.19 (35%)</span></div>
            <div className="flex items-center justify-between"><div className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-purple-500"></span><span className="text-xs text-zinc-400">마케팅부</span></div><span className="text-xs font-mono text-zinc-300">$5.85 (25%)</span></div>
            <div className="flex items-center justify-between"><div className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-green-500"></span><span className="text-xs text-zinc-400">비서실</span></div><span className="text-xs font-mono text-zinc-300">$4.21 (18%)</span></div>
            <div className="flex items-center justify-between"><div className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-yellow-500"></span><span className="text-xs text-zinc-400">정보분석부</span></div><span className="text-xs font-mono text-zinc-300">$2.81 (12%)</span></div>
            <div className="flex items-center justify-between"><div className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-zinc-600"></span><span className="text-xs text-zinc-400">기타</span></div><span className="text-xs font-mono text-zinc-300">$2.34 (10%)</span></div>
          </div>
        </div>
      </div>

      {/* Row 3: Quality gate + Recent errors */}
      <div className="grid grid-cols-2 gap-6">
        {/* Quality gate table */}
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
          <div className="px-4 py-3 border-b border-zinc-800">
            <h3 className="text-sm font-semibold text-zinc-50">품질 게이트 현황</h3>
          </div>
          <table className="w-full">
            <thead><tr className="border-b border-zinc-800">
              <th className="text-left py-2.5 px-4 text-xs font-medium text-zinc-500">에이전트</th>
              <th className="text-right py-2.5 px-4 text-xs font-medium text-zinc-500">첫 제출 통과</th>
              <th className="text-right py-2.5 px-4 text-xs font-medium text-zinc-500">재작업</th>
              <th className="text-right py-2.5 px-4 text-xs font-medium text-zinc-500">환각 탐지</th>
            </tr></thead>
            <tbody>
              <tr className="border-b border-zinc-800/50 hover:bg-zinc-800/20 transition-colors">
                <td className="py-2.5 px-4 text-sm text-zinc-300">비서실장</td>
                <td className="py-2.5 px-4 text-right text-xs text-green-400">94%</td>
                <td className="py-2.5 px-4 text-right text-xs font-mono text-zinc-400">2</td>
                <td className="py-2.5 px-4 text-right text-xs text-green-400">0건</td>
              </tr>
              <tr className="border-b border-zinc-800/50 hover:bg-zinc-800/20 transition-colors">
                <td className="py-2.5 px-4 text-sm text-zinc-300">전략분석가</td>
                <td className="py-2.5 px-4 text-right text-xs text-yellow-400">78%</td>
                <td className="py-2.5 px-4 text-right text-xs font-mono text-zinc-400">7</td>
                <td className="py-2.5 px-4 text-right text-xs text-yellow-400">2건</td>
              </tr>
              <tr className="border-b border-zinc-800/50 hover:bg-zinc-800/20 transition-colors">
                <td className="py-2.5 px-4 text-sm text-zinc-300">마케팅봇</td>
                <td className="py-2.5 px-4 text-right text-xs text-green-400">89%</td>
                <td className="py-2.5 px-4 text-right text-xs font-mono text-zinc-400">4</td>
                <td className="py-2.5 px-4 text-right text-xs text-green-400">0건</td>
              </tr>
              <tr className="hover:bg-zinc-800/20 transition-colors">
                <td className="py-2.5 px-4 text-sm text-zinc-300">SNS봇</td>
                <td className="py-2.5 px-4 text-right text-xs text-green-400">96%</td>
                <td className="py-2.5 px-4 text-right text-xs font-mono text-zinc-400">1</td>
                <td className="py-2.5 px-4 text-right text-xs text-green-400">0건</td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg">
          <div className="px-4 py-3 border-b border-zinc-800">
            <h3 className="text-sm font-semibold text-zinc-50">최근 오류</h3>
          </div>
          <div className="divide-y divide-zinc-800/50">
            <div className="px-4 py-3 hover:bg-zinc-800/20 cursor-pointer transition-colors">
              <div className="flex items-center gap-2 mb-1">
                <span className="px-2 py-0.5 rounded-full text-xs bg-red-500/10 text-red-400">API 오류</span>
                <span className="text-xs text-zinc-600">14분 전</span>
              </div>
              <p className="text-sm text-zinc-300">SNS봇: 트위터 API 인증 실패 (401)</p>
            </div>
            <div className="px-4 py-3 hover:bg-zinc-800/20 cursor-pointer transition-colors">
              <div className="flex items-center gap-2 mb-1">
                <span className="px-2 py-0.5 rounded-full text-xs bg-yellow-500/10 text-yellow-400">품질 게이트</span>
                <span className="text-xs text-zinc-600">2시간 전</span>
              </div>
              <p className="text-sm text-zinc-300">전략분석가: 환각 감지 — 재작업 완료</p>
            </div>
            <div className="px-4 py-3 hover:bg-zinc-800/20 cursor-pointer transition-colors">
              <div className="flex items-center gap-2 mb-1">
                <span className="px-2 py-0.5 rounded-full text-xs bg-orange-500/10 text-orange-400">타임아웃</span>
                <span className="text-xs text-zinc-600">어제</span>
              </div>
              <p className="text-sm text-zinc-300">리서치봇: KIS API 응답 타임아웃 (30s)</p>
            </div>
          </div>
        </div>
      </div>
