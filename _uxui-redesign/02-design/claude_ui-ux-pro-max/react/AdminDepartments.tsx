...
{/* GET /api/admin/departments — returns dept list with agent_count, employee_count, cost */}
  ...
  <aside className="w-60 min-w-[240px] bg-zinc-900 border-r border-zinc-800 flex flex-col fixed h-full z-20">
    ...
    <nav className="flex-1 overflow-y-auto p-2 space-y-0.5">
      ...
      <a href="/admin/departments" className="flex items-center gap-2.5 px-2 py-1.5 rounded-md bg-zinc-800 text-zinc-50 cursor-pointer text-sm"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>부서</a>
  ...
  <main className="ml-60 flex-1 flex flex-col min-h-screen overflow-y-auto">
    <div className="h-12 border-b border-zinc-800 flex items-center px-6 gap-3 sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 flex-shrink-0">
      <span className="text-sm font-medium text-zinc-50">부서 관리</span>
      <span className="text-zinc-700">·</span>
      <span className="text-xs text-zinc-500">12개 부서</span>
      <div className="ml-auto flex items-center gap-2">
        <button className="text-xs bg-blue-600 hover:bg-blue-500 text-white px-3 py-1.5 rounded-md">+ 부서 추가</button>
      </div>
    </div>
    <div className="flex-1 p-6">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="text-xs text-zinc-500 mb-1">전체 부서</div>
          <div className="text-2xl font-semibold font-mono">12</div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="text-xs text-zinc-500 mb-1">전체 에이전트</div>
          <div className="text-2xl font-semibold font-mono">42</div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="text-xs text-zinc-500 mb-1">전체 직원</div>
          <div className="text-2xl font-semibold font-mono">18</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
          <div className="px-4 py-3 border-b border-zinc-800 flex items-center justify-between">
            <span className="text-sm font-medium">부서 목록</span>
            <button className="text-xs bg-blue-600 hover:bg-blue-500 text-white px-2 py-1 rounded-md">+ 부서 추가</button>
          </div>
          <div className="divide-y divide-zinc-800">
            <div className="px-4 py-3 flex items-center gap-3 cursor-pointer hover:bg-zinc-800/30">
              <div className="w-8 h-8 bg-blue-500/20 rounded-md flex items-center justify-center flex-shrink-0">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
              </div>
              <div className="flex-1">
                <div className="text-sm font-medium text-zinc-200">AI 전략실</div>
                <div className="text-xs text-zinc-500">에이전트 14 · 직원 3</div>
              </div>
              <span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400">운영중</span>
            </div>
            <div className="px-4 py-3 flex items-center gap-3 cursor-pointer hover:bg-zinc-800/30">
              <div className="w-8 h-8 bg-purple-500/20 rounded-md flex items-center justify-center flex-shrink-0">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#a855f7" strokeWidth="2"><path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253"/></svg>
              </div>
              <div className="flex-1">
                <div className="text-sm font-medium text-zinc-200">리서치팀</div>
                <div className="text-xs text-zinc-500">에이전트 8 · 직원 4</div>
              </div>
              <span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400">운영중</span>
            </div>
            <div className="px-4 py-3 flex items-center gap-3 cursor-pointer hover:bg-zinc-800/30">
              <div className="w-8 h-8 bg-green-500/20 rounded-md flex items-center justify-center flex-shrink-0">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="2"><path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2"/></svg>
              </div>
              <div className="flex-1">
                <div className="text-sm font-medium text-zinc-200">운영팀</div>
                <div className="text-xs text-zinc-500">에이전트 7 · 직원 5</div>
              </div>
              <span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400">운영중</span>
            </div>
            <div className="px-4 py-3 flex items-center gap-3 cursor-pointer hover:bg-zinc-800/30">
              <div className="w-8 h-8 bg-yellow-500/20 rounded-md flex items-center justify-center flex-shrink-0">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#eab308" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
              </div>
              <div className="flex-1">
                <div className="text-sm font-medium text-zinc-200">보안팀</div>
                <div className="text-xs text-zinc-500">에이전트 6 · 직원 2</div>
              </div>
              <span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400">운영중</span>
            </div>
            <div className="px-4 py-3 flex items-center gap-3 cursor-pointer hover:bg-zinc-800/30">
              <div className="w-8 h-8 bg-orange-500/20 rounded-md flex items-center justify-center flex-shrink-0">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#f97316" strokeWidth="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8m-4-4v4"/></svg>
              </div>
              <div className="flex-1">
                <div className="text-sm font-medium text-zinc-200">개발팀</div>
                <div className="text-xs text-zinc-500">에이전트 7 · 직원 4</div>
              </div>
              <span className="px-2 py-0.5 rounded-full text-xs bg-yellow-500/10 text-yellow-400">구성중</span>
            </div>
          </div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
          <div className="text-sm font-medium mb-4">AI 전략실 상세</div>
          <div className="space-y-4">
            <div>
              <div className="text-xs text-zinc-500 mb-1">부서장</div>
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-xs text-white font-medium">김</div>
                <span className="text-sm text-zinc-300">김민준 (인간 직원)</span>
              </div>
            </div>
            <div>
              <div className="text-xs text-zinc-500 mb-2">소속 에이전트 (14)</div>
              <div className="space-y-1">
                <div className="flex items-center justify-between text-sm">
                  <span className="font-mono text-blue-400 text-xs">AGT-001</span>
                  <span className="text-zinc-400">퀀트마스터</span>
                  <span className="px-1.5 py-0.5 rounded text-xs bg-green-500/10 text-green-400">활성</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="font-mono text-blue-400 text-xs">AGT-004</span>
                  <span className="text-zinc-400">시그널헌터</span>
                  <span className="px-1.5 py-0.5 rounded text-xs bg-green-500/10 text-green-400">활성</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="font-mono text-blue-400 text-xs">AGT-007</span>
                  <span className="text-zinc-400">포트폴리오AI</span>
                  <span className="px-1.5 py-0.5 rounded text-xs bg-yellow-500/10 text-yellow-400">대기</span>
                </div>
              </div>
            </div>
            <div>
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button className="flex-1 text-xs bg-red-900/30 hover:bg-red-900/50 text-red-400 px-3 py-1.5 rounded-md">삭제</button>
            </div>
          </div>
        </div>
      </div>
