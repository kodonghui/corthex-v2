...
{/* API: GET /api/commands?page=1&limit=50, GET /api/commands/:id */}
  {/* Sidebar */}
  <aside className="w-60 min-w-[240px] bg-zinc-900 border-r border-zinc-800 flex flex-col fixed h-full z-20">
    ...
    <nav className="flex-1 overflow-y-auto p-2 space-y-0.5">
      ...
      <a href="/app/ops-log" className="flex items-center gap-2.5 px-2 py-1.5 rounded-md bg-zinc-800 text-zinc-50 cursor-pointer text-sm"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>작전일지</a>
  ...
  <main className="ml-60 flex-1 flex flex-col min-h-screen overflow-y-auto">
    <div className="h-12 border-b border-zinc-800 flex items-center px-6 gap-3 sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 flex-shrink-0">
      <span className="text-sm font-medium text-zinc-50">작전일지</span>
      <span className="text-zinc-700">·</span>
      <span className="text-xs text-zinc-500">명령 실행 이력</span>
    ...
    <div className="flex-1 p-6">
      ...
      <div className="flex items-center gap-3 mb-5">
        <input className="bg-zinc-900 border border-zinc-700 text-zinc-300 text-xs px-3 py-1.5 rounded-md placeholder-zinc-600 focus:outline-none focus:border-blue-500 transition-colors w-56" placeholder="명령 검색..." />
        ...
        <select className="bg-zinc-900 border border-zinc-700 text-zinc-400 text-xs px-3 py-1.5 rounded-md focus:outline-none focus:border-blue-500 transition-colors">
          <option>모든 상태</option><option>완료</option><option>실패</option>
        </select>
        <div className="ml-auto">
          <button className="text-xs text-zinc-400 bg-zinc-900 border border-zinc-700 hover:bg-zinc-800 px-3 py-1.5 rounded-md transition-colors cursor-pointer flex items-center gap-1.5">
      ...
      <div className="space-y-3">
        {/* Entry 1 */}
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors cursor-pointer">
          <div className="flex items-start gap-4 px-4 py-3">
            <div className="flex flex-col items-center gap-1 flex-shrink-0">
              <span className="text-xs font-mono text-zinc-500">14:18</span>
              <div className="w-px flex-1 bg-zinc-800" style={{minHeight: "16px"}}></div>
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-1">
                <span className="text-sm font-medium text-zinc-50 truncate">삼성전자 Q1 실적 기반 매수 전략 검토</span>
                <span className="px-2 py-0.5 rounded-full text-xs bg-blue-500/10 text-blue-400 flex-shrink-0">실행중</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-zinc-600">
                <span>김대표 발령</span>
                <span>→</span>
                <span>비서실장 → 전략팀장 → 전략분석가</span>
                <span className="text-zinc-700">·</span>
                <span>14분 경과</span>
              </div>
            </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors cursor-pointer">
          <div className="flex items-start gap-4 px-4 py-3">
            <div className="flex flex-col items-center gap-1 flex-shrink-0">
              <span className="text-xs font-mono text-zinc-500">13:45</span>
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-1">
                <span className="text-sm font-medium text-zinc-50 truncate">주간 마케팅 성과 보고서 작성</span>
                <span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400 flex-shrink-0">완료</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-zinc-600">
                <span>박매니저 발령</span>
                <span>→</span>
                <span>마케팅팀장 → 마케팅봇</span>
                <span className="text-zinc-700">·</span>
                <span>23분 소요</span>
              </div>
            </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors cursor-pointer">
          <div className="flex items-start gap-4 px-4 py-3">
            <div className="flex flex-col items-center gap-1 flex-shrink-0">
              <span className="text-xs font-mono text-zinc-500">12:30</span>
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-1">
                <span className="text-sm font-medium text-zinc-50 truncate">트위터 콘텐츠 5건 예약 발행</span>
                <span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400 flex-shrink-0">완료</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-zinc-600">
                <span>자동 트리거</span>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors cursor-pointer">
          <div className="flex items-start gap-4 px-4 py-3">
            <div className="flex flex-col items-center gap-1 flex-shrink-0">
              <span className="text-xs font-mono text-zinc-500">11:15</span>
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-1">
                <span className="text-sm font-medium text-zinc-50 truncate">경쟁사 가격 동향 주간 모니터링</span>
                <span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400 flex-shrink-0">완료</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-zinc-600">
                <span>아르고스 자동</span>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors cursor-pointer border-red-500/10">
          <div className="flex items-start gap-4 px-4 py-3">
            <div className="flex flex-col items-center gap-1 flex-shrink-0">
              <span className="text-xs font-mono text-zinc-500">10:02</span>
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-1">
                <span className="text-sm font-medium text-zinc-50 truncate">기술팀 인프라 비용 절감 방안 분석</span>
                <span className="px-2 py-0.5 rounded-full text-xs bg-red-500/10 text-red-400 flex-shrink-0">실패</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-zinc-600">
                <span>김대표 발령</span>
                <span>→</span>
                <span>기술팀장</span>
                <span className="text-zinc-700">·</span>
                <span className="text-red-400">도구 권한 오류</span>
              </div>
            </div>
            <button className="text-xs text-blue-400 hover:text-blue-300 transition-colors flex-shrink-0 cursor-pointer">재시도</button>
          </div>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors cursor-pointer">
          <div className="flex items-start gap-4 px-4 py-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-1">
                <span className="text-sm font-medium text-zinc-50 truncate">일일 시장 브리핑 (자동 크론)</span>
                <span className="px-2 py-0.5 rounded-full text-xs bg-green-500/10 text-green-400 flex-shrink-0">완료</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-zinc-600">
                <span>크론 자동</span>
