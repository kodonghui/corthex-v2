...
{/* GET /api/admin/agent-marketplace — returns marketplace agents with tool_count, avg_cost, install_count */}
  {/* Sidebar */}
  <aside className="w-60 min-w-[240px] bg-zinc-900 border-r border-zinc-800 flex flex-col fixed h-full z-20">
    ...
    <nav className="flex-1 overflow-y-auto p-2 space-y-0.5">
      ...
      <a href="/admin/agent-marketplace" className="flex items-center gap-2.5 px-2 py-1.5 rounded-md bg-zinc-800 text-zinc-50 cursor-pointer text-sm"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>에이전트마켓</a>
  ...
  <main className="ml-60 flex-1 flex flex-col min-h-screen overflow-y-auto">
    <div className="h-12 border-b border-zinc-800 flex items-center px-6 gap-3 sticky top-0 bg-zinc-950/90 backdrop-blur-sm z-10 flex-shrink-0">
      <span className="text-sm font-medium text-zinc-50">에이전트 마켓</span>
      <span className="text-zinc-700">·</span>
      <span className="text-xs text-zinc-500">사전 구성 AI 에이전트</span>
      <div className="ml-auto flex items-center gap-2">
        <button className="text-xs bg-zinc-800 hover:bg-zinc-700 text-zinc-300 px-3 py-1.5 rounded-md">내 에이전트 공개</button>
      </div>
    </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 hover:border-zinc-700 transition-colors">
          <div className="flex items-start gap-3 mb-3">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center text-white text-sm font-bold flex-shrink-0">Q</div>
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <span className="text-sm font-medium text-zinc-200">퀀트엘리트 Pro</span>
                <span className="px-1.5 py-0.5 rounded text-xs bg-yellow-500/10 text-yellow-400">프리미엄</span>
              </div>
              <div className="text-xs text-zinc-500 mt-0.5">by CORTHEX Labs</div>
            </div>
            <div className="text-right">
              <div className="text-xs text-yellow-400">★★★★★</div>
              <div className="text-xs text-zinc-600">5.0 (47)</div>
            </div>
          </div>
          <p className="text-xs text-zinc-500 mb-3">기관급 퀀트 알고리즘 적용. 샤프비율 최적화 포트폴리오 운용. KIS 실전 연동.</p>
          <div className="flex items-center gap-3 text-xs text-zinc-600 mb-3">
            <span>도구 6개</span>
            <span>·</span>
            <span>월 평균 ₩420K 소진</span>
            <span>·</span>
            <span>847 설치</span>
          </div>
          <div className="flex gap-2">
            <button className="flex-1 text-xs bg-zinc-800 hover:bg-zinc-700 text-zinc-300 px-3 py-1.5 rounded-md">상세보기</button>
            <button className="flex-1 text-xs bg-blue-600 hover:bg-blue-500 text-white px-3 py-1.5 rounded-md">조직에 추가</button>
          </div>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 hover:border-zinc-700 transition-colors">
          <div className="flex items-start gap-3 mb-3">
            <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-teal-600 rounded-lg flex items-center justify-center text-white text-sm font-bold flex-shrink-0">N</div>
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <span className="text-sm font-medium text-zinc-200">뉴스허브 Analyst</span>
                <span className="px-1.5 py-0.5 rounded text-xs bg-green-500/10 text-green-400">무료</span>
              </div>
              <div className="text-xs text-zinc-500 mt-0.5">by 오픈소스 커뮤니티</div>
            </div>
            <div className="text-right">
              <div className="text-xs text-yellow-400">★★★★☆</div>
              <div className="text-xs text-zinc-600">4.3 (203)</div>
            </div>
          </div>
          <p className="text-xs text-zinc-500 mb-3">국내외 경제 뉴스 실시간 집계 · 분류 · 감성 점수. 일일 브리핑 자동 생성.</p>
          <div className="flex items-center gap-3 text-xs text-zinc-600 mb-3">
            <span>도구 3개</span>
            <span>·</span>
            <span>월 평균 ₩85K 소진</span>
            <span>·</span>
            <span>3,291 설치</span>
          </div>
          <div className="flex gap-2">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 hover:border-zinc-700 transition-colors">
          <div className="flex items-start gap-3 mb-3">
            <div className="w-10 h-10 bg-gradient-to-br from-red-500 to-orange-600 rounded-lg flex items-center justify-center text-white text-sm font-bold flex-shrink-0">R</div>
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <span className="text-sm font-medium text-zinc-200">RiskGuard 3.0</span>
                <span className="px-1.5 py-0.5 rounded text-xs bg-blue-500/10 text-blue-400">검증</span>
              </div>
              <div className="text-xs text-zinc-500 mt-0.5">by RiskAI Korea</div>
            </div>
            <div className="text-right">
              <div className="text-xs text-yellow-400">★★★★★</div>
              <div className="text-xs text-zinc-600">4.9 (91)</div>
            </div>
          </div>
          <p className="text-xs text-zinc-500 mb-3">포트폴리오 VaR · MDD 실시간 모니터링. 임계치 초과 시 즉각 경보 및 자동 헤지.</p>
          <div className="flex items-center gap-3 text-xs text-zinc-600 mb-3">
            <span>도구 4개</span>
            <span>·</span>
            <span>월 평균 ₩130K 소진</span>
            <span>·</span>
            <span>1,024 설치</span>
          </div>
          <div className="flex gap-2">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 hover:border-zinc-700 transition-colors">
          <div className="flex items-start gap-3 mb-3">
            <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-600 rounded-lg flex items-center justify-center text-white text-sm font-bold flex-shrink-0">S</div>
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <span className="text-sm font-medium text-zinc-200">SNS 트렌드 스카우트</span>
                <span className="px-1.5 py-0.5 rounded text-xs bg-green-500/10 text-green-400">무료</span>
              </div>
              <div className="text-xs text-zinc-500 mt-0.5">by 커뮤니티</div>
            </div>
            <div className="text-right">
              <div className="text-xs text-yellow-400">★★★★☆</div>
              <div className="text-xs text-zinc-600">4.1 (156)</div>
            </div>
          </div>
          <p className="text-xs text-zinc-500 mb-3">X·네이버·카카오 SNS 트렌드 실시간 수집. 종목 언급량 급등 조기 감지.</p>
          <div className="flex items-center gap-3 text-xs text-zinc-600 mb-3">
            <span>도구 5개</span>
            <span>·</span>
            <span>월 평균 ₩92K 소진</span>
            <span>·</span>
            <span>2,183 설치</span>
          </div>
          <div className="flex gap-2">
