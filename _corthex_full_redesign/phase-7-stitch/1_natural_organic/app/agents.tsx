    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div>
          ...
          <textarea value={soul} onChange={(e) => setSoul(e.target.value)} className="w-full h-64 p-3 rounded-lg border border-slate-300 bg-white text-sm font-mono resize-y focus:outline-none focus:ring-2" style={{ focusRingColor: '#5a7247' }} placeholder="에이전트의 Soul을 작성하세요..." />
          <div className="mt-2">
          ...
          <div className="flex items-center gap-4 flex-1 max-w-xl">
            <div className="relative w-full">
              ...
              <input
                ...
                style={{ backgroundColor: '#faf8f5', focusRingColor: '#4a5d40' }}
