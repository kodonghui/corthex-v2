...
export function ClassifiedPage() {
  ...
  return (
    <div data-testid="classified-page" className="font-sans min-h-screen" style={{ backgroundColor: '#fcfbf9', color: '#1e293b' }}>
      {/* BEGIN: MainHeader */}
            ...
            <div className="overflow-y-auto pr-2 space-y-4">
              {listQuery.isLoading ? (
                ...
                items.map((item, idx) => {
                  ...
                  const isCleared = item.qualityReview?.conclusion === 'pass' || item.qualityScore != null && item.qualityScore >= 3
                  return (
                    <article
                      key={item.id}
