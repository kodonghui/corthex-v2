  ...
  return (
    <div className="step-transition">
      <header className="mb-10 text-center">
        <h1 className="text-3xl font-bold text-stone-800 mb-3" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>템플릿 선택</h1>
        ...
        {templates.map((t) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-stone-800 mb-1" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>{t.name}</h3>
...
function Step2Summary({
  ...
  return (
    <div className="step-transition">
      <header className="mb-10 text-center">
        <h1 className="text-3xl font-bold text-stone-800 mb-3" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>설정 완료</h1>
      ...
      <div className="space-y-6 mb-10" data-purpose="summary-container">
        ...
        <div className="rounded-2xl p-6 border" style={{ backgroundColor: ORGANIC.olivePale, borderColor: `${ORGANIC.olive}1a` }}>
          <h3 className="font-bold mb-4 flex items-center" style={{ color: ORGANIC.olive, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
        ...
        <div className="bg-stone-50 rounded-2xl p-6 border border-stone-100">
          <h3 className="text-stone-800 font-bold mb-4 flex items-center" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
...
export function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: ORGANIC.bg, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
