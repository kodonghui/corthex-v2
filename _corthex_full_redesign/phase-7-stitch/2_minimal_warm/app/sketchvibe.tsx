    ...
    <div className="flex h-screen w-full" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
      ...
      <div className="w-64 text-white flex flex-col h-full flex-shrink-0 z-20 shadow-lg" style={{ backgroundColor: '#e57373' }}>
        <div className="p-6 flex items-center gap-3 border-b" style={{ borderColor: '#4a5d23' }}>
          ...
          <h2 className="text-xl font-bold tracking-wide" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>SketchVibe</h2>
        </div>
      ...
      <div className="flex-1 flex flex-col relative overflow-hidden" style={{ backgroundColor: '#fcfbf9' }}>
        ...
        <header className="h-16 flex items-center justify-between px-8 absolute top-0 w-full z-10 pointer-events-none" style={{ background: 'linear-gradient(to bottom, rgba(0,0,0,0.05), transparent)' }}>
          <div className="flex items-center gap-4 pointer-events-auto backdrop-blur-md px-4 py-2 rounded-2xl shadow-sm" style={{ backgroundColor: 'rgba(255,255,255,0.8)' }}>
            ...
            {dirty && <span className="text-xs" style={{ color: '#e07a5f' }}>(unsaved)</span>}
          </div>
          <div className="flex items-center gap-4 pointer-events-auto">
            {autoSaveToast && (
              <span className="text-xs px-3 py-1 rounded-full" style={{ backgroundColor: 'rgba(90,114,71,0.1)', color: '#e57373' }}>
                Auto-saved
              </span>
            )}
            <button
        ...
        {/* Canvas Content */}
        <div className="flex-1 w-full h-full relative cursor-move" style={{ backgroundImage: 'radial-gradient(#e8e4d9 1px, transparent 1px)', backgroundSize: '24px 24px' }}>
          <ReactFlow
            nodes={nodes}
            edges={edges}
          ...
          >
            ...
            <Controls
              ...
              style={{ borderColor: '#e8e4d9', backgroundColor: '#ffffff' }}
            />
            <MiniMap
              nodeStrokeWidth={3}
              pannable
              zoomable
              style={{ backgroundColor: '#fcfbf9', border: '1px solid #e8e4d9', borderRadius: '12px' }}
            />
          </ReactFlow>
        ...
        <div className="absolute bottom-24 right-8 flex flex-col gap-2 z-20">
          <button
            ...
            style={{ backgroundColor: '#ffffff', borderColor: '#e8e4d9', color: '#6a5d43' }}
          >
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20">
          <div className="rounded-full shadow-xl px-6 py-3 flex items-center gap-6 border" style={{ backgroundColor: '#ffffff', borderColor: '#e8e4d9' }}>
            ...
            <div className="w-px h-8" style={{ backgroundColor: '#e8e4d9' }}></div>
            <button
      ...
      {chatOpen && selectedAgent && selectedSessionId && (
        <div className="w-96 border-l flex flex-col h-full" style={{ borderColor: '#e8e4d9', backgroundColor: '#fcfbf9' }}>
          <ChatArea
            agent={selectedAgent}
      ...
      {showSaveDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ backgroundColor: 'rgba(0,0,0,0.3)' }}>
          <div className="rounded-2xl shadow-2xl p-6 w-96 mx-4" style={{ backgroundColor: '#ffffff', border: '1px solid #e8e4d9' }}>
            ...
            <input
              ...
              style={{ borderColor: '#e8e4d9', color: '#463e30', backgroundColor: '#fcfbf9' }}
              autoFocus
            />
      ...
      {showMermaidModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ backgroundColor: 'rgba(0,0,0,0.3)' }}>
          <div className="rounded-2xl shadow-2xl p-6 w-[500px] mx-4" style={{ backgroundColor: '#ffffff', border: '1px solid #e8e4d9' }}>
