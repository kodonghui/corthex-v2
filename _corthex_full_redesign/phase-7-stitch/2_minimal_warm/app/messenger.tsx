...
export function MessengerPage() {
  ...
  return (
    <div className="h-screen overflow-hidden flex text-slate-800" data-testid="messenger-page">
      ...
      <aside className="flex flex-col h-full border-r border-stone-200" style={{ width: '280px', minWidth: '280px', backgroundColor: '#f5f3ec' }} data-purpose="main-navigation">
        <div className="p-6">
          <h1 className="text-2xl" style={{ color: '#e57373', fontFamily: ''Inter', 'Noto Sans KR', sans-serif' }}>CORTHEX v2</h1>
        </div>
        <nav className="flex-1 px-4 space-y-2 overflow-y-auto">
          <a className="flex items-center space-x-3 p-3 rounded-2xl bg-white shadow-sm font-medium" style={{ color: '#e57373' }} href="#">
        ...
        <div className="p-4 border-t border-stone-200">
          <div className="flex items-center space-x-3 p-2">
            <img alt="Profile" className="w-10 h-10 rounded-full border-2" style={{ borderColor: '#e57373' }} src="https://lh3.googleusercontent.com/aida-public/AB6AXuDMp-FxfvF0m7GV0KfI5jA6erih0Txm_8bC9TEL63l6NoQz4QwRE-Mb0eSIAVvvuR2DuREeTMzhXQKfBnSKvnu7Eyy-aIZjXVYm1aCfpewy2paefNM0bQ2PDkz2PFPV06kFovdjrbqQ8wIjql0gbrdaZloauzGtP-2OuuMbyZNVQGj3BomG3SiYdpl27X0VlOf5b5ytoXBxASUl0YFlUuCXpyjTryVIIfcAsvfzJ4UTcxRCCp6I6DvkMPUil8sQ9Ff6Z9aYI5BCr7Zy" />
            <div>
      ...
      <section className="w-80 border-r border-stone-200 flex flex-col" style={{ backgroundColor: '#fcfbf9' }} data-purpose="conversation-selector">
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl" style={{ fontFamily: ''Inter', 'Noto Sans KR', sans-serif' }}>Inbox</h2>
            <button className="p-2 text-white rounded-full transition-colors" style={{ backgroundColor: '#e57373' }}>
          ...
          <div className="relative">
            <input className="w-full bg-stone-100 border-none rounded-2xl px-4 py-2 text-sm focus:ring-2" style={{ '--tw-ring-color': 'rgba(229, 115, 115,0.2)' } as React.CSSProperties} placeholder="Search conversations..." type="text" />
          </div>
        </div>
        <div className="flex-1 overflow-y-auto px-3 space-y-1">
          ...
          <div className="flex items-center p-3 rounded-2xl bg-white shadow-sm border border-stone-100 cursor-pointer">
            <div className="relative">
              ...
              <span className="absolute bottom-0 right-0 w-3 h-3 border-2 border-white rounded-full" style={{ backgroundColor: '#81b29a' }}></span>
            </div>
          ...
          <div className="flex items-center p-3 rounded-2xl hover:bg-stone-100 transition-colors cursor-pointer">
            <div className="relative flex -space-x-4">
              <img alt="Group" className="w-8 h-8 rounded-2xl border-2 border-white" style={{ backgroundColor: '#f4a261' }} src="https://lh3.googleusercontent.com/aida-public/AB6AXuACT4O4itqWSahF5NmeCuAa7vKcFyTBARmEyQKfyKnxBJLRPl1uFMpBMyzU8o0er1E2qsU_zbPAYNqOLZobHZQB8PxKaiJ-MojNV8_H6ao7WUIF7YpO0UeDaOd3lX9KpT3ZH0fZ4H0U8SNEHhgFXGQmwwi9hqGSPhUlnYvj8ypibEkLdKPpkAv2TK-yj2_7Y64xfztK6f69qtmkwEpAqNEdbSrjjNGuA4tQtc-eN8h5WMeg-zARXanFnCZJaW8IuGNnTnw1I2MWkxXG" />
              <img alt="Group" className="w-8 h-8 rounded-2xl border-2 border-white" style={{ backgroundColor: '#e57373' }} src="https://lh3.googleusercontent.com/aida-public/AB6AXuD4KlDNWsXO0cllGlLx9cw473Y4E0YGHEBnPoqgr2b62NjTo3tY32QcXtZx_v4mPLmOBophmU0tXBewpq9JxA2WxuZbYSRXafAM5g1Pvp-jQ1XzRK-14W1DoIqeONygny2543Vbr6EAGmGmlvcx1A1sVdq6sqyykCzz4RPdoRbSAtmWrFQG9U-g_kA1jOgqvMTJAleD_-5mI5VWkis6t5BdK791D40uYuTEyeayBhno1uvsPqktjWy0z7HpWQQb95mMMBeYfavqcAls" />
            </div>
            <div className="ml-3 flex-1 overflow-hidden">
              <div className="flex justify-between items-baseline">
      ...
      <main className="flex-1 flex flex-col bg-white" data-purpose="chat-main-interface">
        ...
        <header className="h-20 border-b border-stone-100 flex items-center justify-between px-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h2 className="text-lg" style={{ fontFamily: ''Inter', 'Noto Sans KR', sans-serif' }}>Elena Gilbert</h2>
              <p className="text-xs font-medium" style={{ color: '#81b29a' }}>Active now</p>
            </div>
          </div>
          <div className="flex items-center space-x-4 text-stone-400">
            <button className="transition-colors" style={{ ['--hover-color' as string]: '#e57373' }}>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-6" style={{ backgroundColor: 'rgba(250,248,245,0.3)' }}>
          ...
          <div className="flex items-start justify-end space-x-3">
            <div className="max-w-md">
              <div className="p-4 rounded-2xl rounded-tr-none shadow-sm text-white" style={{ backgroundColor: '#e57373' }}>
              ...
              <div className="flex items-center justify-end mt-1 space-x-2">
                ...
                <span style={{ color: '#81b29a' }}><svg className="h-3 w-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path clipRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" fillRule="evenodd"></path></svg></span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="max-w-md">
              <div className="bg-white p-4 rounded-2xl rounded-tl-none shadow-sm border border-stone-100 space-y-3">
                ...
                {/* File Card */}
                <div className="flex items-center p-3 rounded-xl border border-stone-200" style={{ backgroundColor: '#fcfbf9' }}>
                  <div className="p-2 rounded-lg" style={{ backgroundColor: 'rgba(244, 162, 97,0.2)', color: '#e07a5f' }}>
                  ...
                  <button className="ml-auto" style={{ color: '#e57373' }}>
        ...
        <footer className="p-6 bg-white border-t border-stone-100">
          <div className="flex items-center space-x-4 p-2 rounded-2xl" style={{ backgroundColor: '#fcfbf9' }}>
            ...
            <div className="flex items-center space-x-2 px-2">
              <button className="text-stone-400 transition-colors" style={{ ['--hover-color' as string]: '#f4a261' }}>
              ...
              <button className="text-white p-2 rounded-xl shadow-md transition-transform active:scale-95" style={{ backgroundColor: '#e57373' }}>
      ...
      {/* BEGIN: Info Panel */}
      <aside className="hidden xl:flex flex-col overflow-y-auto border-l border-stone-200" style={{ width: '280px', minWidth: '280px', backgroundColor: '#fcfbf9' }} data-purpose="details-panel">
        <div className="p-8 flex flex-col items-center text-center">
          ...
          <h2 className="text-xl" style={{ fontFamily: ''Inter', 'Noto Sans KR', sans-serif' }}>Elena Gilbert</h2>
          <p className="text-sm text-stone-500">Senior UX Designer</p>
          <div className="flex space-x-2 mt-6">
            <button className="flex flex-col items-center space-y-1 p-3 bg-white rounded-2xl shadow-sm border border-stone-100 w-20 transition-all" style={{ ['--hover-border' as string]: '#f4a261' }}>
              <svg className="h-5 w-5" style={{ color: '#e57373' }} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
