...
export function JobsPage() {
  ...
  const oliveGreen = '#81b29a'
  const emeraldAccent = '#3a5a40'
  const sage = '#a3b18a'

  return (
    <div className="flex h-screen overflow-hidden" data-testid="jobs-page" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
        ...
        <div className="p-8">
          ...
          <div className="bg-white rounded-2xl border shadow-sm overflow-hidden" style={{ borderColor: `${oliveGreen}1a` }}>
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y" style={{ divideColor: `${oliveGreen}0d` }}>
                {isTabLoading && (
                  <tr>
