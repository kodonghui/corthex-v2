...
export function TradingPage() {
  ...
  return (
    <div data-testid="trading-page" className="h-[calc(100dvh-var(--header-h,56px))] flex flex-col overflow-hidden" style={{ backgroundColor: '#fcfbf9' }}>
      {/* BEGIN: TopHeader */}
      <header className="h-16 bg-white border-b border-stone-200 flex items-center justify-between px-6 shrink-0 z-20">
        <div className="flex items-center gap-4">
          <div className="text-white p-2 rounded-lg" style={{ backgroundColor: '#e57373' }}>
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M13 10V3L4 14h7v7l9-11h-7z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
            </svg>
          </div>
          <h1 className="text-xl font-bold tracking-tight" style={{ color: '#e57373' }}>CORTHEX <span className="text-stone-400 font-medium">v2</span></h1>
          <nav className="ml-8 flex gap-6 text-sm font-medium text-stone-500">
            <a className="border-b-2 pb-5 pt-5" style={{ color: '#e57373', borderColor: '#e57373' }} href="#">Strategy Room</a>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold animate-pulse" style={{ backgroundColor: 'rgba(224, 122, 95,0.1)', color: '#e07a5f' }} id="trading-warning">
        ...
        <section className="w-96 flex flex-col bg-white rounded-2xl shadow-sm border border-stone-100 overflow-hidden" data-purpose="chat-panel">
          <div className="p-4 border-b border-stone-100 flex items-center gap-3">
            <div className="relative">
              <div className="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs" style={{ backgroundColor: '#e57373' }}>CIO</div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4" style={{ backgroundColor: 'rgba(250,248,245,0.3)' }}>
            ...
            <div className="flex flex-col items-end">
              <div className="text-white p-3 rounded-2xl rounded-tr-none text-sm max-w-[85%]" style={{ backgroundColor: '#e57373' }}>
          ...
          <div className="p-4 border-t border-stone-100 bg-white">
            <div className="relative">
              ...
              <button className="absolute bottom-2 right-2 p-2 text-white rounded-lg transition-colors" style={{ backgroundColor: '#e57373' }}>
