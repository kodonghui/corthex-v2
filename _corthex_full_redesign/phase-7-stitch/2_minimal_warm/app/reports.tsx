...
export function ReportsPage() {
  ...
  if (view === 'create') {
    return (
      <div className="h-full flex flex-col" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif", backgroundColor: organicBeige }} data-testid="reports-page">
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif", backgroundColor: organicBeige }} data-testid="reports-page">
