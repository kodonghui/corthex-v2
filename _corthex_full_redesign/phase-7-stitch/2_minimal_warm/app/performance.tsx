...
export function PerformancePage() {
  ...
  return (
    <div className="min-h-screen flex" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif", backgroundColor: bgLight, color: '#0f172a' }} data-testid="performance-page">
      {/* Sidebar */}
