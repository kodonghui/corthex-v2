    ...
    <div className="sm:hidden fixed bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-stone-100 via-stone-100 to-transparent pt-12 z-10 pointer-events-none">
      <div className="bg-white rounded-xl shadow-lg border border-stone-200 p-4 pointer-events-auto">
        ...
        <div className="flex justify-between items-center divide-x divide-stone-200">
          ...
          <div className="flex flex-col items-center flex-1">
            <span className="text-2xl font-semibold font-mono tabular-nums" style={{ color: '#e57373' }}>{stats.total}</span>
...
export function SnsPage() {
  ...
  return (
    <div data-testid="sns-page" className="min-h-screen flex" style={{ backgroundColor: '#fcfbf9' }}>
      {/* Fixed Sidebar */}
      <aside className="w-64 fixed inset-y-0 left-0 bg-white border-r border-stone-200 flex flex-col z-50">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-10 h-10 rounded-full flex items-center justify-center text-white" style={{ backgroundColor: '#81b29a' }}>
              <span className="material-symbols-outlined">eco</span>
            </div>
            <div className="flex flex-col">
              <h1 className="text-lg font-bold leading-none tracking-tight">CORTHEX v2</h1>
              <p className="text-xs font-medium" style={{ color: '#81b29a' }}>Minimal Warm Edition</p>
            </div>
          </div>
          <nav className="space-y-1">
            ...
            <a className="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors" style={{ backgroundColor: 'rgba(129, 178, 154,0.1)', color: '#81b29a' }} href="#">
      ...
      <main className="ml-64 flex-1 flex flex-col min-h-screen">
        ...
        <header className="h-16 bg-white/80 backdrop-blur-md border-b border-stone-200 px-8 flex items-center justify-between sticky top-0 z-40">
          <div className="flex items-center gap-2">
            <span className="material-symbols-outlined" style={{ color: '#81b29a' }}>hub</span>
          ...
          <div className="flex items-center gap-6">
            <div className="relative group">
              ...
              <input className="pl-10 pr-4 py-2 bg-stone-100 border-none rounded-xl text-sm focus:ring-2 w-64 transition-all" style={{ '--tw-ring-color': 'rgba(129, 178, 154,0.2)' } as React.CSSProperties} placeholder="Search content..." type="text" />
            </div>
            <button className="flex items-center gap-2 text-white px-4 py-2 rounded-xl text-sm font-bold hover:shadow-lg transition-all" style={{ backgroundColor: '#e07a5f' }}>
        ...
        <div className="p-8 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
            ...
            <button className="flex items-center gap-2 text-white px-6 py-3 rounded-xl font-bold hover:opacity-90 transition-all shadow-md" style={{ backgroundColor: '#81b29a' }}>
            ...
            <div className="flex gap-8">
              {TAB_ITEMS.map((item) => (
                <button
                  ...
                  style={tab === item.value ? { borderColor: '#81b29a', color: '#81b29a' } : {}}
                >
                  {item.label}
                </button>
              ))}
          ...
          {tab === 'content' && (
            <div className="flex flex-wrap gap-3 mb-8">
              ...
              <button className="ml-auto text-sm font-bold flex items-center gap-1 hover:underline" style={{ color: '#81b29a' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-xl border border-stone-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
              ...
              <div className="p-4">
                <div className="flex items-center gap-2 mb-2">
                  <span className="material-symbols-outlined text-xs" style={{ color: '#81b29a' }}>calendar_today</span>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-stone-100">
                  ...
                  <button className="text-xs font-bold uppercase tracking-widest transition-colors" style={{ color: '#81b29a' }}>Approve</button>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-stone-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
              ...
              <div className="p-4">
                <div className="flex items-center gap-2 mb-2">
                  <span className="material-symbols-outlined text-xs" style={{ color: '#81b29a' }}>schedule</span>
            ...
            <div className="bg-white rounded-xl border border-stone-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
              ...
              <div className="p-4">
                <div className="flex items-center gap-2 mb-2">
                  <span className="material-symbols-outlined text-xs" style={{ color: '#81b29a' }}>event_available</span>
            ...
            <div className="bg-white rounded-xl border border-stone-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow group opacity-75 grayscale hover:grayscale-0 transition-all">
              ...
              <div className="p-4">
                <div className="flex items-center gap-2 mb-2">
                  <span className="material-symbols-outlined text-xs" style={{ color: '#81b29a' }}>check_circle</span>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-stone-100">
                  ...
                  <button className="text-xs font-bold uppercase tracking-widest transition-colors" style={{ color: '#81b29a' }}>View Stats</button>
                </div>
              </div>
            </div>

            {/* Create New Empty Card */}
            <button className="border-2 border-dashed border-stone-200 rounded-xl flex flex-col items-center justify-center p-8 hover:bg-white transition-all group min-h-[320px]" style={{ ['--hover-border' as string]: 'rgba(129, 178, 154,0.4)' }}>
              <div className="w-12 h-12 rounded-full bg-stone-100 flex items-center justify-center mb-4 transition-colors" style={{ ['--group-hover-bg' as string]: 'rgba(129, 178, 154,0.1)' }}>
