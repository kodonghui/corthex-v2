...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#fcfbf9', fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
      {/* API: POST /api/auth/login */}
      <main className="w-full max-w-md">
        ...
        <header className="text-center mb-8">
          ...
          >
            <span className="text-2xl font-bold" style={{ color: '#e57373', fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>C</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-800" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>CORTHEX v2</h1>
        ...
        >
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {/* Error Message */}
            {error && (
              <div className="p-3 rounded-lg text-sm" style={{ backgroundColor: 'rgba(224, 122, 95, 0.05)', border: '1px solid rgba(224, 122, 95, 0.2)', color: '#e07a5f' }}>
                <p>{error}</p>
              </div>
            )}
            ...
            <div className="flex items-center justify-between text-xs text-gray-500 pt-2">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input className="rounded border-gray-300" type="checkbox" style={{ color: '#e57373' }} />
                <span>아이디 저장</span>
              </label>
