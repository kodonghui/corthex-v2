...
const TIER_BADGE_STYLES: Record<number, { bg: string; label: string }> = {
  0: { bg: '#f4a261', label: 'Manager' },
  1: { bg: '#e57373', label: 'Specialist' },
...
export function TiersPage() {
  ...
  if (isError) {
    return (
      <div data-testid="tiers-page" style={{ backgroundColor: '#fcfbf9' }} className="min-h-screen">
  ...
  return (
    <div data-testid="tiers-page" className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden" style={{ backgroundColor: '#fcfbf9', fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
      <div className="layout-container flex h-full grow flex-col">
        {/* Top Navigation */}
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid px-6 md:px-20 py-4" style={{ borderColor: 'rgba(229, 115, 115,0.1)', backgroundColor: '#fcfbf9' }}>
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-3" style={{ color: '#e57373' }}>
              <span className="material-symbols-outlined text-3xl font-bold">account_tree</span>
              <h2 className="text-slate-900 text-lg font-bold leading-tight tracking-tight uppercase">CORTHEX <span style={{ color: 'rgba(229, 115, 115,0.7)' }}>v2</span></h2>
            </div>
            <nav className="hidden md:flex items-center gap-6">
              <a className="text-slate-600 hover:transition-colors text-sm font-medium" href="#" style={{ color: '#e57373' }}>Dashboard</a>
              <a className="text-slate-600 hover:transition-colors text-sm font-medium" href="#">Workspace</a>
              <a className="text-sm font-semibold border-b-2 pb-1" href="#" style={{ color: '#e57373', borderColor: '#e57373' }}>Tiers</a>
              <a className="text-slate-600 hover:transition-colors text-sm font-medium" href="#">Settings</a>
            </nav>
          </div>
          <div className="flex flex-1 justify-end gap-6 items-center">
            <label className="hidden sm:flex flex-col min-w-40 h-10 max-w-64">
              <div className="flex w-full flex-1 items-stretch rounded-xl h-full border bg-white" style={{ borderColor: 'rgba(229, 115, 115,0.2)' }}>
                <div className="flex items-center justify-center pl-3" style={{ color: 'rgba(229, 115, 115,0.5)' }}>
            ...
            <div className="rounded-full p-1 border" style={{ backgroundColor: 'rgba(229, 115, 115,0.1)', borderColor: 'rgba(229, 115, 115,0.2)' }}>
        ...
        <main className="flex-1 px-6 md:px-20 py-10 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-10">
            <div className="flex flex-col gap-2">
              <nav className="flex items-center gap-2 text-xs font-medium mb-1 uppercase tracking-wider" style={{ color: 'rgba(229, 115, 115,0.6)' }}>
                <span>Workspace</span>
            ...
            <button
              ...
              style={{ backgroundColor: '#e57373', boxShadow: '0 10px 15px -3px rgba(229, 115, 115,0.2)' }}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="p-6 rounded-xl bg-white border shadow-sm flex items-center gap-4" style={{ borderColor: 'rgba(229, 115, 115,0.1)' }}>
              <div className="size-12 rounded-full flex items-center justify-center" style={{ backgroundColor: 'rgba(229, 115, 115,0.1)', color: '#e57373' }}>
          ...
          {tiers.length > 0 && (
            <div className="bg-white rounded-xl border shadow-xl overflow-hidden" style={{ borderColor: 'rgba(229, 115, 115,0.1)' }}>
              <div className="p-5 border-b flex justify-between items-center" style={{ borderColor: 'rgba(229, 115, 115,0.1)', backgroundColor: 'rgba(248,250,252,0.5)' }}>
                <h3 className="font-bold text-slate-700 flex items-center gap-2">
                  <span className="material-symbols-outlined" style={{ color: '#e57373' }}>list_alt</span>
                  Active Configuration
                </h3>
                <div className="flex gap-2">
                  <button className="p-2 rounded-lg border hover:opacity-80" style={{ borderColor: 'rgba(229, 115, 115,0.2)', color: '#e57373' }}>
                    <span className="material-symbols-outlined text-sm">filter_list</span>
                  </button>
                  <button onClick={() => refetch()} className="p-2 rounded-lg border hover:opacity-80" style={{ borderColor: 'rgba(229, 115, 115,0.2)', color: '#e57373' }}>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y" style={{ divideColor: 'rgba(229, 115, 115,0.05)' }}>
                    {tiers.map((tier, index) => {
                      const badge = getTierBadge(index)
                      return (
                        <tr key={tier.id} data-testid={`tier-row-${tier.id}`} className="transition-colors" style={{ cursor: 'pointer' }} onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = 'rgba(229, 115, 115,0.02)')} onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = 'transparent')}>
                          <td className="px-6 py-5">
                            <span className="text-lg font-black" style={{ color: 'rgba(229, 115, 115,0.3)' }}>{String(tier.tierLevel).padStart(2, '0')}</span>
                          </td>
                          <td className="px-6 py-5">
              ...
              <div className="p-4 flex justify-between items-center text-xs text-slate-500" style={{ backgroundColor: 'rgba(248,250,252,0.5)' }}>
                <p>Endpoint: <code className="px-1 rounded" style={{ backgroundColor: 'rgba(229, 115, 115,0.05)' }}>GET /api/admin/tier-configs</code></p>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex gap-4">
              <div className="size-10 rounded-lg flex items-center justify-center shrink-0" style={{ backgroundColor: 'rgba(229, 115, 115,0.1)', color: '#e57373' }}>
        ...
        {/* Footer */}
        <footer className="px-6 md:px-20 py-8 border-t mt-20" style={{ borderColor: 'rgba(229, 115, 115,0.1)' }}>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-400 uppercase tracking-widest font-bold">
            ...
            <div className="flex gap-6">
              <a className="hover:opacity-80" href="#" style={{ color: '#e57373' }}>API Documentation</a>
              <a className="hover:opacity-80" href="#" style={{ color: '#e57373' }}>System Status</a>
              <a className="hover:opacity-80" href="#" style={{ color: '#e57373' }}>Privacy Policy</a>
            </div>
          </div>
        </footer>
      </div>
