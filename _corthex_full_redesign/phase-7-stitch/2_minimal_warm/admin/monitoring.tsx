/**
 * Admin Monitoring Page — Minimal Warm Theme
 *
 * API Endpoints:
...
function MemoryBadge({ percent }: { percent: number }) {
  const color = percent >= 90 ? '#ef4444' : percent >= 80 ? terracotta : olive
  const bg = percent >= 90 ? 'rgba(239,68,68,0.1)' : percent >= 80 ? 'rgba(224,122,95,0.1)' : oliveBg
  return (
    ...
    return (
      <div className="min-h-screen" style={{ backgroundColor: cream, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
        <div className="p-8 max-w-5xl mx-auto w-full" data-testid="monitoring-page">
          <h1 className="text-3xl font-black tracking-tight mb-6" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif", color: warmBrown }}>
            System Monitoring
          </h1>
          ...
          <div className="bg-white rounded-xl border shadow-sm overflow-hidden" style={{ borderColor: sand }} data-testid="server-card">
            <div className="px-6 py-4 border-b flex items-center justify-between" style={{ borderColor: sand, backgroundColor: `${cream}80` }}>
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-sm font-bold" style={{ color: warmBrown, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>Server Status</h3>
              </div>
            ...
            <div className="px-6 py-5 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-mono" style={{ color: lightMuted }}>
                  #{d.server.version.build}{d.server.version.hash && <> &middot; <span style={{ color: '#8a8a8a' }}>{d.server.version.hash}</span></>}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border shadow-sm overflow-hidden" style={{ borderColor: sand }} data-testid="memory-card">
            <div className="px-6 py-4 border-b flex items-center justify-between" style={{ borderColor: sand, backgroundColor: `${cream}80` }}>
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-sm font-bold" style={{ color: warmBrown, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>Memory</h3>
              </div>
          ...
          <div className="bg-white rounded-xl border shadow-sm overflow-hidden" style={{ borderColor: sand }} data-testid="db-card">
            <div className="px-6 py-4 border-b flex items-center justify-between" style={{ borderColor: sand, backgroundColor: `${cream}80` }}>
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-sm font-bold" style={{ color: warmBrown, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>Database</h3>
              </div>
          ...
          <div className="bg-white rounded-xl border shadow-sm overflow-hidden" style={{ borderColor: sand }} data-testid="error-card">
            <div className="px-6 py-4 border-b flex items-center justify-between" style={{ borderColor: sand, backgroundColor: `${cream}80` }}>
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-sm font-bold" style={{ color: warmBrown, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>Errors (24h)</h3>
              </div>
              <span
