/**
 * Report Lines Page — Minimal Warm Theme
 *
 * API Endpoints:
...
export function ReportLinesPage() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-y-auto" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif", color: '#2c2c2c' }}>
      {/* Top Bar */}
      <header className="h-16 border-b border-slate-200 px-8 flex items-center justify-between sticky top-0 z-10" style={{ backgroundColor: 'rgba(255,255,255,0.8)', backdropFilter: 'blur(8px)' }}>
        <div className="flex items-center gap-2 text-slate-500 text-sm">
          ...
          <span className="font-medium" style={{ color: '#2c2c2c' }}>보고 라인 설정</span>
        </div>
      ...
      <div className="p-8 max-w-5xl mx-auto w-full">
        {/* Page Header */}
        <div className="mb-10">
          <h2 className="text-3xl font-bold mb-3" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif", color: '#2c2c2c' }}>보고 라인 설정</h2>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm mb-8">
          <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-4" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>새 보고 라인 추가</h3>
                    ...
                    <tr key={u.id} className="group hover:bg-slate-50/50 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-sm font-medium" style={{ color: '#2c2c2c' }}>{u.name}</p>
                      ...
                      <td className="px-6 py-4">
                        {reportTarget ? (
                          <div className="flex items-center gap-3">
                            <div
                              className="size-8 rounded-full flex items-center justify-center font-bold text-xs"
                              style={{ backgroundColor: 'rgba(244,162,97,0.1)', color: '#f4a261' }}
                            >
                              {reportTarget.name.charAt(0)}
                            </div>
                            <div>
                              <p className="text-sm font-medium" style={{ color: '#2c2c2c' }}>{reportTarget.name}</p>
