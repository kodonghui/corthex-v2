/**
 * Admin Settings Page — Minimal Warm Theme
 *
 * API Endpoints:
  ...
  return (
    <div className="bg-white rounded-xl border shadow-sm p-6" style={{ borderColor: sand }} data-testid="settings-company-info">
      <div className="flex items-center gap-3 mb-5">
        ...
        <h2 className="text-lg font-bold" style={{ color: warmBrown, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>Company Info</h2>
      </div>
...
function ApiKeySection({ companyId }: { companyId: string }) {
  ...
  const inputStyle = { borderColor: sand, color: warmBrown, backgroundColor: '#fcfbf9' }
    ...
    <div className="bg-white rounded-xl border shadow-sm p-6" style={{ borderColor: sand }} data-testid="settings-api-keys">
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold" style={{ color: warmBrown, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>API Key Management</h2>
      ...
      {/* Rotate form */}
      {rotateTarget && (
        <div className="mb-5 p-5 rounded-xl space-y-3 border" style={{ backgroundColor: 'rgba(224,122,95,0.05)', borderColor: terracotta }}>
  ...
  return (
    <div className="bg-white rounded-xl border shadow-sm p-6" style={{ borderColor: sand }} data-testid="settings-handoff-depth">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h2 className="text-lg font-bold" style={{ color: warmBrown, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>Handoff Depth</h2>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        />
        <span className="text-3xl font-black w-12 text-center tabular-nums" style={{ color: olive, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>{depth}</span>
      </div>
...
function DefaultSettingsSection({
  ...
  const selectStyle = { borderColor: sand, color: warmBrown, backgroundColor: '#fcfbf9' }
  ...
  return (
    <div className="bg-white rounded-xl border shadow-sm p-6" style={{ borderColor: sand }} data-testid="settings-defaults">
      <div className="flex items-center gap-3 mb-5">
        ...
        <h2 className="text-lg font-bold" style={{ color: warmBrown, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>Default Settings</h2>
      </div>
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: cream, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
      <div className="p-8 max-w-4xl mx-auto" data-testid="settings-page">
        <div className="mb-8">
          <h1 className="text-3xl font-black tracking-tight" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif", color: warmBrown }}>
            Settings
          </h1>
