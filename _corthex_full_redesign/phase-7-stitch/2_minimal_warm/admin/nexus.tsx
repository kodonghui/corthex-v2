/**
 * NEXUS Admin Page — Minimal Warm Theme
 * (Original Stitch HTML used orange #ec5b13, converted to olive-green #e57373)
 *
 * API Endpoints:
...
// -- Minimal Warm color tokens (replacing Stitch Default orange) --
const ORGANIC = {
  primary: '#e57373',       // olive-green
  secondary: '#e07a5f',     // terracotta
  accent: '#f4a261',        // gold
  bg: '#fcfbf9',            // organic-beige
  bgDark: '#1a1a1a',
  surface: '#ffffff',
  text: '#2c2c2c',
}
...
function NexusCanvas() {
  ...
  if (!selectedCompanyId) {
    return (
      <div className="space-y-6" data-testid="nexus-page">
        <h1 className="text-xl font-semibold tracking-tight" style={{ color: ORGANIC.text, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>NEXUS 조직도</h1>
  ...
  return (
    <div className="flex h-screen w-full flex-col" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif", color: ORGANIC.text }}>
      {/* Top Navigation Bar */}
      <header className="flex items-center justify-between border-b border-slate-200 px-6 py-3 z-50" style={{ backgroundColor: ORGANIC.bg }}>
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold tracking-tight" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="p-2 rounded-xl transition-colors" style={{ backgroundColor: 'rgba(229,115,115,0.1)' }}>
            <span className="material-symbols-outlined text-xl">notifications</span>
          </button>
          <button className="p-2 rounded-xl transition-colors" style={{ backgroundColor: 'rgba(229,115,115,0.1)' }}>
            <span className="material-symbols-outlined text-xl">settings</span>
          </button>
          <div className="h-8 w-8 rounded-full border-2 overflow-hidden" style={{ backgroundColor: 'rgba(229,115,115,0.2)', borderColor: ORGANIC.primary }}></div>
        </div>
      </header>
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <aside className="w-20 lg:w-64 border-r border-slate-200 flex flex-col p-4 gap-2" style={{ backgroundColor: ORGANIC.bg }}>
          ...
          <button className="flex items-center gap-3 p-3 rounded-xl transition-colors" style={{ ['--hover-bg' as string]: 'rgba(229,115,115,0.1)' }}>
            <span className="material-symbols-outlined">dashboard</span>
            <span className="hidden lg:block text-sm font-medium">Dashboard</span>
          </button>
          <button className="flex items-center gap-3 p-3 rounded-xl text-white shadow-lg" style={{ backgroundColor: ORGANIC.primary, boxShadow: `0 10px 15px -3px rgba(229,115,115,0.3)` }}>
          ...
          >
            <div className="p-6 border-b border-slate-200">
              <div className="flex items-center justify-between mb-2">
                <h2 className="text-lg font-bold" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>Agent Property Panel</h2>
            ...
            {/* Footer Action */}
            <div className="p-6 border-t border-slate-200" style={{ backgroundColor: 'rgba(229,115,115,0.05)' }}>
              ...
              <button
                ...
                style={{ backgroundColor: ORGANIC.primary, boxShadow: `0 20px 25px -5px rgba(229,115,115,0.3)` }}
              >
