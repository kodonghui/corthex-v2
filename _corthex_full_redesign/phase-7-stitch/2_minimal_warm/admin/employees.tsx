/**
 * Admin Employees (Employee Assignment) — Minimal Warm Theme
 *
 * API Endpoints:
...
export function EmployeesPage() {
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ backgroundColor: cream, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
      {/* Main Content */}
        ...
        <div className="flex-1 overflow-hidden flex flex-col p-8 gap-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  style={{ backgroundColor: olive, boxShadow: '0 4px 6px -1px rgba(229,115,115,0.2)' }}
          ...
          <div className="flex-1 flex gap-6 overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3">
                {isLoading ? (
                  ...
                  employees.filter((e) => e.departments.length === 0).map((emp) => (
                    <div key={emp.id} className="group flex items-center gap-3 p-3 rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 cursor-move hover:shadow-md transition-all" style={{ borderColor: 'transparent' }} onMouseEnter={(e) => (e.currentTarget.style.borderColor = 'rgba(229,115,115,0.5)')} onMouseLeave={(e) => (e.currentTarget.style.borderColor = 'transparent')}>
            ...
            <div className="flex-1 overflow-y-auto grid grid-cols-1 md:grid-cols-2 gap-4 content-start pb-8">
              {departments.map((dept) => {
                ...
                return (
                  <div key={dept.id} className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col">
                    ...
                    <div className="p-4 space-y-2 min-h-[120px] border-2 border-dashed border-transparent transition-all rounded-b-xl" style={{}} onMouseEnter={(e) => (e.currentTarget.style.borderColor = 'rgba(229,115,115,0.2)')} onMouseLeave={(e) => (e.currentTarget.style.borderColor = 'transparent')}>
              ...
              <button className="border-2 border-dashed border-slate-300 dark:border-slate-800 rounded-xl flex flex-col items-center justify-center p-8 text-slate-400 transition-all" style={{}} onMouseEnter={(e) => { e.currentTarget.style.borderColor = 'rgba(229,115,115,0.5)'; e.currentTarget.style.color = olive }} onMouseLeave={(e) => { e.currentTarget.style.borderColor = '#cbd5e1'; e.currentTarget.style.color = '#94a3b8' }}>
