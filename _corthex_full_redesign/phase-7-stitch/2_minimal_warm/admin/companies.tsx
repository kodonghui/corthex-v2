/**
 * Admin Companies Page — Minimal Warm Theme
 *
 * API Endpoints:
 *   GET    /admin/companies
      ...
      <div className="p-8 max-w-5xl mx-auto w-full" data-testid="companies-page">
        ...
        {showCreate && (
          <div className="bg-white rounded-xl border p-6 mb-6 shadow-sm" style={{ borderColor: sand }} data-testid="company-create-form">
            <h3 className="text-lg font-bold mb-4" style={{ color: warmBrown, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>New Company</h3>
            <form
              onSubmit={(e) => {
                e.preventDefault()
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h3 className="text-lg font-bold" style={{ color: warmBrown, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>{c.name}</h3>
