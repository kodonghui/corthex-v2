/**
 * Onboarding Wizard Page — Minimal Warm Theme
 *
 * API Endpoints:
            ...
            <li key={step.num} className="relative z-10 flex flex-col items-center group">
              <div
                ...
                style={{
                  ...
                  ...(isActive ? { boxShadow: `0 0 0 4px rgba(224,122,95,0.2)` } : {}),
      ...
      <section className="bg-white rounded-2xl shadow-sm border overflow-hidden" style={{ borderColor: OC.sand }}>
        <div className="p-8">
          <div className="text-center space-y-2 mb-6">
            <div className="w-12 h-12 mx-auto rounded-full flex items-center justify-center" style={{ backgroundColor: 'rgba(224,122,95,0.1)' }}>
          ...
          <div className="grid grid-cols-2 gap-3 max-w-sm mx-auto">
            <div className="rounded-lg px-4 py-3 text-center" style={{ backgroundColor: 'rgba(224,122,95,0.1)' }}>
            ...
            <div className="rounded-lg px-4 py-3 text-center" style={{ backgroundColor: 'rgba(129,178,154,0.2)' }}>
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                {alreadyExists && (
                  <span className="text-xs px-2 py-0.5 rounded-full" style={{ backgroundColor: 'rgba(224,122,95,0.1)', color: OC.olive }}>
                    등록됨
                  </span>
                )}
              </div>
    ...
    <section className="bg-white rounded-2xl shadow-sm border overflow-hidden" style={{ borderColor: OC.sand }}>
      ...
      <div className="p-8 space-y-6">
        ...
        {invited.length > 0 && (
          <div className="space-y-2">
            {invited.map((emp, idx) => (
              <div key={idx} className="flex items-center justify-between px-4 py-3 rounded-lg border" style={{ backgroundColor: 'rgba(224,122,95,0.05)', borderColor: OC.leaf }}>
                <div>
...
export function OnboardingWizardPage() {
  ...
  if (!selectedCompanyId) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: OC.cream, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: OC.cream, fontFamily: "'Inter', 'Noto Sans KR', sans-serif", color: '#1e293b' }}>
      {/* Navigation Header */}
