/**
 * Admin Workflows Page — Minimal Warm Theme
 *
 * API Endpoints:
...
const oliveActive = '#c75050'
const terracotta = '#e07a5f'
const cream = '#fcfbf9'
const sand = '#e8e4d9'
const warmBrown = '#2c2c2c'
const muted = '#6b6b6b'
const lightMuted = '#8a8a8a'
const leafLight = '#e8e4d9'
...
const stepTypeLabels: Record<string, { label: string; color: string; bg: string }> = {
  ...
  condition: { label: 'Condition', color: terracotta, bg: 'rgba(224,122,95,0.1)' },
}
...
function WorkflowFormModal({ workflow, isPending, onSubmit, onClose }: {
  ...
  const inputStyle = { backgroundColor: '#fcfbf9', borderColor: sand, color: warmBrown }
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-lg font-bold mb-4" style={{ color: warmBrown, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
        ...
        <div className="mb-4">
          ...
          <div className="space-y-3">
            {steps.map((step, idx) => (
              <div key={step.id} className="border rounded-lg p-3 space-y-2" style={{ backgroundColor: '#fcfbf9', borderColor: sand }} data-testid={`form-step-${idx}`}>
          ...
          <div className="p-6 flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-1 mt-4">
              <button
                ...
                onMouseEnter={e => (e.currentTarget.style.backgroundColor = '#d35f5f')}
        ...
        <div className="flex-1 flex flex-col relative overflow-hidden" style={{ backgroundColor: cream }}>
          <header className="border-b px-8 py-6 flex items-center justify-between" style={{ backgroundColor: '#ffffff', borderColor: sand }}>
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold" style={{ color: warmBrown, fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
                      ...
                      return (
                        <div key={step.id} className="flex items-start gap-3" data-testid={`step-${idx}`}>
                          <div className="flex flex-col items-center">
                            <div className="w-8 h-8 rounded-full border flex items-center justify-center text-xs font-mono" style={{ backgroundColor: '#fcfbf9', borderColor: sand, color: muted }}>
                              {idx + 1}
                            </div>
    ...
    <div className="flex h-screen w-full" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif" }}>
        ...
        <div className="p-6 flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-1 mt-4">
            <button
              ...
              onMouseEnter={e => { if (activeTab !== 'list') e.currentTarget.style.backgroundColor = '#d35f5f' }}
            ...
            <button
              ...
              onMouseEnter={e => { if (activeTab !== 'suggestions') e.currentTarget.style.backgroundColor = '#d35f5f' }}
      ...
      <div className="flex-1 flex flex-col relative overflow-hidden" style={{ backgroundColor: cream }}>
        <header className="border-b px-8 py-6" style={{ backgroundColor: '#ffffff', borderColor: sand }}>
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl" style={{ fontFamily: "'Inter', 'Noto Sans KR', sans-serif", color: warmBrown }}>Admin Workflows</h1>
            ...
            <button
              ...
              style={{ backgroundColor: terracotta, boxShadow: '0 10px 15px -3px rgba(224,122,95,0.2)' }}
