            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-800 border border-slate-600 focus:border-corthex-accent focus:ring-1 focus:ring-corthex-accent rounded-lg px-3 py-2 text-sm text-white placeholder-slate-500 outline-none"
                />
              </div>
              <div>
                  ...
                  {['read', 'write', 'execute'].map((scope) => (
                    <label key={scope} className="flex items-center gap-1.5 text-sm text-slate-300 cursor-pointer">
                      <input
                        ...
                        className="rounded-sm border-slate-600 bg-slate-800 text-corthex-accent focus:ring-corthex-accent focus:ring-offset-0"
                      />
                      {scope}
                    </label>
                  ))}
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-800 border border-slate-600 focus:border-corthex-accent focus:ring-1 focus:ring-corthex-accent rounded-lg px-3 py-2 text-sm text-white outline-none [color-scheme:dark]"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  min={1}
                  max={10000}
                  className="w-full bg-slate-800 border border-slate-600 focus:border-corthex-accent focus:ring-1 focus:ring-corthex-accent rounded-lg px-3 py-2 text-sm text-white outline-none"
                />
              </div>
            </div>
