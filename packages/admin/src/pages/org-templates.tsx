...
const modalInput = 'bg-slate-800 border border-slate-600 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/40 focus:outline-none rounded-lg px-3 py-2 text-sm text-slate-50 w-full'
      ...
      >
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-blue-900/20 rounded-lg px-4 py-3 text-center">
              <p className="text-2xl font-bold text-blue-300">{result.agentsCreated}</p>
              ...
              <div key={t.id} className="flex items-center justify-between py-2 px-3 bg-slate-800 rounded-lg">
                ...
                {t.isPublished ? (
                  ...
                  <button
                    ...
                    className="px-3 py-1 text-xs text-blue-400 border border-blue-800 rounded-lg hover:bg-blue-900/20 transition-colors disabled:opacity-50"
                  >
                    마켓에 공개
                  </button>
                )}
