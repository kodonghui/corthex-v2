...
/*
 * Documentation:
 * Select — https://app.subframe.com/fe1d14ed3033/library?component=Select_bb88f90b-8c43-4b73-9c2f-3558ce7838f3
 */

import React from "react";
import { FeatherCheck } from "../subframe-shim";
    ...
    <SubframeCore.Select.Content asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex w-full flex-col items-start overflow-hidden rounded-md border border-solid border-neutral-border bg-corthex-surface px-1 py-1 shadow-lg",
          className
        )}
        ref={ref}
      >
