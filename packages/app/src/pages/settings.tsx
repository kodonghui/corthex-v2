...
const inputBase = 'w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl border h-14 placeholder:text-corthex-text-secondary p-[15px] text-base font-normal leading-normal transition-all focus:outline-none focus:ring-1'
...
function ProfileTab() {
  ...
  if (isLoading) {
    return <div className="text-center py-8 text-sm" style={{ color: 'var(--color-corthex-text-secondary)' }}>불러오는 중...</div>
  }
  ...
  return (
    <div data-testid="profile-tab">
      {/* 회사 정보 Section */}
      <section>
        <h2 className="text-[22px] font-bold leading-tight tracking-tight pb-6" style={{ fontFamily: "'Inter', sans-serif", color: 'var(--color-corthex-text-primary)' }}>회사 정보</h2>
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-4">
            <label className="flex flex-col flex-1">
              <p className="text-base font-medium leading-normal pb-2" style={{ color: 'var(--color-corthex-text-secondary)' }}>사용자명</p>
              <input type="text" value={profile?.username || ''} readOnly className={inputReadOnly} style={{ ...inputStyle, color: 'var(--color-corthex-text-secondary)', outlineColor: 'var(--color-corthex-accent)' }} />
            </label>
          </div>
          <div className="flex flex-col gap-4">
            <label className="flex flex-col flex-1">
              <p className="text-base font-medium leading-normal pb-2" style={{ color: 'var(--color-corthex-text-secondary)' }}>이메일</p>
              <input type="text" value={profile?.email || '미설정'} readOnly className={inputReadOnly} style={{ ...inputStyle, color: 'var(--color-corthex-text-secondary)' }} />
            </label>
          </div>
          <div className="flex flex-col gap-4">
            <label className="flex flex-col flex-1">
              <p className="text-base font-medium leading-normal pb-2" style={{ color: 'var(--color-corthex-text-secondary)' }}>이름</p>
              <input
                type="text"
                value={editName}
                onChange={(e) => setEditName(e.target.value)}
                className={inputEditable}
                style={{ ...inputStyle, color: 'var(--color-corthex-text-primary)' }}
              />
            </label>
          </div>
          <div className="flex flex-col gap-4">
            <label className="flex flex-col flex-1">
              <p className="text-base font-medium leading-normal pb-2" style={{ color: 'var(--color-corthex-text-secondary)' }}>역할</p>
              <input
                type="text"
                value={profile?.role === 'admin' ? '관리자' : profile?.role === 'ceo' ? 'CEO' : '직원'}
                readOnly
                className={inputReadOnly}
                style={{ ...inputStyle, color: 'var(--color-corthex-text-secondary)' }}
              />
            </label>
          </div>
          <button
      ...
      <div className="w-full h-px my-10" style={{ backgroundColor: 'var(--color-corthex-border)' }} />

      {/* 비밀번호 변경 Section */}
      <section>
        <h2 className="text-[22px] font-bold leading-tight tracking-tight pb-6" style={{ fontFamily: "'Inter', sans-serif", color: 'var(--color-corthex-text-primary)' }}>비밀번호 변경</h2>
        <div className="flex flex-col gap-5">
          <label className="flex flex-col flex-1">
            <p className="text-base font-medium leading-normal pb-2" style={{ color: 'var(--color-corthex-text-secondary)' }}>새 비밀번호</p>
            <input
              type="password"
              value={newPassword}
          ...
          <label className="flex flex-col flex-1">
            <p className="text-base font-medium leading-normal pb-2" style={{ color: 'var(--color-corthex-text-secondary)' }}>비밀번호 확인</p>
            <input
              type="password"
...
function DisplayTab() {
  ...
  const ACCENT_COLORS = [
    { value: 'olive', color: 'var(--color-corthex-accent)', label: 'Olive (기본값)' },
    ...
    { value: 'stone', color: 'var(--color-corthex-text-secondary)', label: 'Stone' },
  ]
  ...
  return (
    <div data-testid="display-tab">
      {/* 테마 Section */}
      <section>
        <h2 className="text-[22px] font-bold leading-tight tracking-tight pb-6" style={{ fontFamily: "'Inter', sans-serif", color: 'var(--color-corthex-text-primary)' }}>테마</h2>
        <div className="flex flex-col gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <span className="ml-2 text-sm font-medium" style={{ color: 'var(--color-corthex-text-secondary)' }}>Olive (기본값)</span>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* 언어 Section */}
      <section>
        <h2 className="text-[22px] font-bold leading-tight tracking-tight pb-6" style={{ fontFamily: "'Inter', sans-serif", color: 'var(--color-corthex-text-primary)' }}>언어</h2>
        <div className="flex flex-col gap-4">
          <label className="flex flex-col flex-1">
            <p className="text-base font-medium leading-normal pb-2" style={{ color: 'var(--color-corthex-text-secondary)' }}>언어</p>
            <select
              value={language}
          ...
          <p className="text-xs" style={{ color: 'var(--color-corthex-text-secondary)' }}>언어 변경은 향후 업데이트에서 전체 UI에 적용됩니다</p>
        </div>
      </section>
    </div>
  )
...
function CommandCenterTab() {
  ...
  return (
    <div data-testid="command-center-tab">
      <section>
        <h2 className="text-[22px] font-bold leading-tight tracking-tight pb-6" style={{ fontFamily: "'Inter', sans-serif", color: 'var(--color-corthex-text-primary)' }}>허브 설정</h2>
        <div className="flex flex-col gap-6">
          {/* Auto scroll toggle */}
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              <p className="text-base font-medium" style={{ color: 'var(--color-corthex-text-primary)' }}>자동 스크롤</p>
              <p className="text-sm mt-1" style={{ color: 'var(--color-corthex-text-secondary)' }}>새 메시지가 올 때 자동으로 아래로 스크롤합니다</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              <div
                ...
                style={{ backgroundColor: autoScroll ? 'var(--color-corthex-accent)' : 'var(--color-corthex-text-secondary)' }}
              />
            </label>
          </div>
          {/* Sound toggle */}
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              <p className="text-base font-medium" style={{ color: 'var(--color-corthex-text-primary)' }}>알림 소리</p>
              <p className="text-sm mt-1" style={{ color: 'var(--color-corthex-text-secondary)' }}>에이전트 응답 완료 시 알림 소리를 재생합니다</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input checked={sound} onChange={toggleSound} className="sr-only peer" type="checkbox" />
              <div
                className="w-12 h-6 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-corthex-surface after:border-corthex-border after:border after:rounded-full after:h-5 after:w-5 after:transition-all"
                style={{ backgroundColor: sound ? 'var(--color-corthex-accent)' : 'var(--color-corthex-text-secondary)' }}
              />
            </label>
          </div>
        </div>
...
function PlaceholderTab() {
  return (
    <div className="text-center py-16">
      <p className="text-sm" style={{ color: 'var(--color-corthex-text-secondary)' }}>준비 중입니다</p>
      <p className="text-xs mt-1" style={{ color: 'var(--color-corthex-text-secondary)' }}>이 기능은 향후 업데이트에서 제공됩니다</p>
    </div>
  )
}
    ...
    <div data-testid="api-key-tab">
      <section>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-[22px] font-bold leading-tight tracking-tight" style={{ fontFamily: "'Inter', sans-serif", color: 'var(--color-corthex-text-primary)' }}>API 연동</h2>
          <button
        ...
        {showForm && (
          <div className="mb-6 p-5 rounded-2xl border flex flex-col gap-4" style={{ borderColor: 'rgba(96,108,56,0.3)', backgroundColor: 'rgba(96,108,56,0.03)' }}>
            ...
            <label className="flex flex-col flex-1">
              <p className="text-base font-medium leading-normal pb-2" style={{ color: 'var(--color-corthex-text-secondary)' }}>라벨 (선택)</p>
              <input
                type="text"
                value={formLabel}
            ...
            {fields.map((f) => (
              <label key={f.key} className="flex flex-col flex-1">
                <p className="text-base font-medium leading-normal pb-2" style={{ color: 'var(--color-corthex-text-secondary)' }}>{f.label}</p>
                <input
                  type={f.type}
            ...
            <p className="text-xs" style={{ color: 'var(--color-corthex-text-secondary)' }}>모든 키는 서버에서 암호화되어 저장됩니다</p>
            <button
        ...
        <div className="flex flex-col gap-3">
          {keysLoading ? (
            <div className="text-center py-8 text-sm" style={{ color: 'var(--color-corthex-text-secondary)' }}>불러오는 중...</div>
          ) : keys.length === 0 ? (
            <div className="text-center py-8 text-sm" style={{ color: 'var(--color-corthex-text-secondary)' }}>
              등록된 API key가 없습니다
            </div>
          ) : (
            keys.map((key) => (
              <div
                ...
                style={{ borderColor: 'var(--color-corthex-border)', boxShadow: '0 4px 20px -2px rgba(0, 0, 0, 0.05)' }}
              >
                <div>
                  <div className="flex items-center gap-2">
                    <span className="text-base font-medium" style={{ color: 'var(--color-corthex-text-primary)' }}>
                      {PROVIDER_LABELS[key.provider] || key.provider}
                    </span>
                    <Badge variant="success">연동됨</Badge>
                  </div>
                  {key.label && (
                    <p className="text-sm mt-0.5" style={{ color: 'var(--color-corthex-text-secondary)' }}>{key.label}</p>
                  )}
                  <p className="text-xs font-mono tabular-nums" style={{ color: 'var(--color-corthex-text-secondary)' }}>
      ...
      <section>
        <h2 className="text-[22px] font-bold leading-tight tracking-tight pb-6" style={{ fontFamily: "'Inter', sans-serif", color: 'var(--color-corthex-text-primary)' }}>서비스 연동 안내</h2>
        <div className="flex flex-col gap-3">
          <div className="p-4 rounded-2xl bg-corthex-surface border" style={{ borderColor: 'var(--color-corthex-border)', boxShadow: '0 4px 20px -2px rgba(0, 0, 0, 0.05)' }}>
            <span className="font-medium" style={{ color: 'var(--color-corthex-text-primary)' }}>KIS 증권</span>
            <span className="text-sm" style={{ color: 'var(--color-corthex-text-secondary)' }}> -- 한국투자증권 API key를 등록하면 에이전트가 매매 현황을 조회할 수 있습니다.</span>
          </div>
          <div className="p-4 rounded-2xl bg-corthex-surface border" style={{ borderColor: 'var(--color-corthex-border)', boxShadow: '0 4px 20px -2px rgba(0, 0, 0, 0.05)' }}>
            <span className="font-medium" style={{ color: 'var(--color-corthex-text-primary)' }}>노션</span>
            <span className="text-sm" style={{ color: 'var(--color-corthex-text-secondary)' }}> -- 노션 API key를 등록하면 노션 연동 도구를 사용할 수 있습니다.</span>
          </div>
        </div>
      </section>
    </div>
...
function TelegramSection() {
  ...
  return (
    <div data-testid="telegram-tab">
      <h2 className="text-[22px] font-bold leading-tight tracking-tight pb-6" style={{ fontFamily: "'Inter', sans-serif", color: 'var(--color-corthex-text-primary)' }}>텔레그램 연동</h2>
      {config?.isActive ? (
        <div className="p-5 rounded-2xl border flex flex-col gap-4" style={{ borderColor: 'rgba(16,185,129,0.3)', backgroundColor: 'rgba(16,185,129,0.03)' }}>
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-mono" style={{ color: 'var(--color-corthex-text-secondary)' }}>Chat ID: {config.ceoChatId || '미설정'}</span>
          </div>
        ...
        <div className="flex flex-col gap-5">
          <label className="flex flex-col flex-1">
            <p className="text-base font-medium leading-normal pb-2" style={{ color: 'var(--color-corthex-text-secondary)' }}>봇 토큰</p>
            <input type="password" value={botToken} onChange={(e) => setBotToken(e.target.value)}
              placeholder="봇 토큰 (@BotFather에서 발급)" className={inputEditable} style={{ ...inputStyle, color: 'var(--color-corthex-text-primary)' }} />
          </label>
          <label className="flex flex-col flex-1">
            <p className="text-base font-medium leading-normal pb-2" style={{ color: 'var(--color-corthex-text-secondary)' }}>CEO 채팅 ID (선택)</p>
            <input value={ceoChatId} onChange={(e) => setCeoChatId(e.target.value)}
              placeholder="CEO 채팅 ID" className={inputEditable} style={{ ...inputStyle, color: 'var(--color-corthex-text-primary)' }} />
          </label>
