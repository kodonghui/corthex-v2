                        ...
                        <div key={step.id} className="flex items-start gap-3" data-testid={`step-${idx}`}>
                          <div className="flex flex-col items-center">
                            ...
                            {idx < detail.steps.length - 1 && (
                              <div className="w-px h-6 mt-1" style={{ backgroundColor: '#e5e1d3' }} />
                            )}
                          </div>
                          <div className="flex-1 border rounded-lg p-4" style={{ backgroundColor: '#ffffff', borderColor: '#e5e1d3' }}>
  ...
  return (
    <div className="flex flex-col h-full w-full" style={{ fontFamily: "'Pretendard', sans-serif", backgroundColor: '#faf8f5' }}>
        ...
        <header className="border-b px-8 py-6" style={{ backgroundColor: '#ffffff', borderColor: '#e5e1d3' }}>
          ...
          {/* Tabs */}
          <div className="flex border-b mt-8 gap-8" style={{ borderColor: '#e5e1d3' }} data-testid="workflow-tabs">
            {tabs.map(t => (
              <button
                key={t.key}
...
function ExecutionCard({ execution, statusInfo }: { execution: WorkflowExecution; statusInfo: { label: string; color: string; bg: string } }) {
  ...
  return (
    <div className="border rounded-xl overflow-hidden" style={{ backgroundColor: '#ffffff', borderColor: '#e5e1d3' }} data-testid={`execution-${execution.id}`}>
      <div
        ...
        style={{ backgroundColor: expanded ? '#fbfaf8' : 'transparent' }}
      >
        <div className="flex items-center gap-3">
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundColor: '#ffffff', border: '1px solid #e5e1d3' }}
        tabIndex={-1}
