...
// ============================================================
// AgentDetailPanel -- slide-in from right (readonly)
// ============================================================
      ...
      <div className="fixed right-0 top-0 z-50 h-full w-80 bg-white dark:bg-zinc-900 border-l border-zinc-200 dark:border-zinc-800 shadow-xl animate-slide-left overflow-y-auto">
        <div className="p-5 space-y-5">
          <div className="flex items-center justify-between">
            ...
            <button onClick={onClose} aria-label="닫기" className="text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 text-xl leading-none">&times;</button>
          </div>
...
export function OrgPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent>
          ...
          {isEmpty && (
            <div className="text-center py-12 space-y-3">
              ...
              <p className="text-xs text-zinc-400">관리자에게 조직 설정을 요청해 주세요.</p>
            </div>
          )}
      ...
      {/* Agent detail side panel (readonly) */}
