...
export function ImprovementCard({ title, description, icon }: ImprovementCardProps) {
    return (
        <div className="flex flex-col gap-3 rounded-xl p-5 border border-corthex-border bg-corthex-surface/40 hover:bg-corthex-bg transition-colors cursor-pointer group">
            <div className="flex items-center gap-3">
                <div className="flex items-center justify-center size-10 rounded-lg bg-corthex-accent/10 text-corthex-accent">
                    {icon}
                </div>
                <h3 className="text-corthex-text-primary text-sm font-bold">{title}</h3>
            </div>
