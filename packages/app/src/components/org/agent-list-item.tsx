...
export function AgentListItem({ id, name, role, colorClass, status }: AgentListItemProps) {
    ...
    return (
        <div className="flex items-center justify-between p-3 rounded-xl bg-corthex-surface border border-corthex-border hover:border-corthex-accent/50 transition-colors cursor-pointer group">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <p className="text-sm font-semibold group-hover:text-corthex-accent transition-colors text-corthex-text-primary">{name}</p>
