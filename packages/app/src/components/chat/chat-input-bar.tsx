...
export function ChatInputBar({ agentName = 'Agent' }: ChatInputBarProps) {
    return (
        <div className="p-4 bg-corthex-bg border-t border-stone-200">
            <div className="flex items-end gap-2 bg-corthex-surface rounded-2xl p-2 border border-stone-200/50 shadow-inner focus-within:ring-1 focus-within:ring-corthex-accent/50 transition-all">
                ...
                <button className="flex items-center justify-center bg-corthex-accent text-corthex-text-on-accent rounded-full w-10 h-10 shrink-0 hover:bg-corthex-accent-hover transition-colors shadow-sm">
