...
export function ChatInputBar({ agentName = 'Agent' }: ChatInputBarProps) {
    return (
        <div className="p-4 bg-[#0B1120] border-t border-stone-200">
            <div className="flex items-end gap-2 bg-white rounded-2xl p-2 border border-stone-200/50 shadow-inner focus-within:ring-1 focus-within:ring-[#5a7247]/50 transition-all">
                ...
                <button className="flex items-center justify-center bg-[#5a7247] text-[#0B1120] rounded-full w-10 h-10 shrink-0 hover:bg-[#869e71] transition-colors shadow-sm">
