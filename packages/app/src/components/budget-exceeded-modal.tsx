...
export function BudgetExceededModal({ data, onConfirm }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white dark:bg-zinc-900 rounded-xl p-6 mx-4 max-w-sm w-full shadow-xl border border-red-200 dark:border-red-800">
        ...
        <div className="space-y-2 mb-4">
          <div className="flex justify-between text-sm">
            <span className="text-zinc-500 dark:text-zinc-400">현재 비용</span>
            <span className="font-semibold text-red-600 dark:text-red-400">
              ${data.currentSpendUsd.toFixed(2)}
            </span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-zinc-500 dark:text-zinc-400">예산 한도</span>
