...
export function Toolbar({ title = "NEXUS", subtitle = "Global Operations Network", zoomLevel = 100 }: ToolbarProps) {
    return (
        <header className="h-12 border-b border-corthex-border bg-corthex-surface/50/50 backdrop-blur-md flex items-center justify-between px-4 z-10 flex-shrink-0">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center bg-corthex-elevated rounded-lg p-0.5">
                    <button className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-corthex-surface text-corthex-text-secondary transition-colors" title="Zoom Out">
                        <Minus className="w-4 h-4" />
                    </button>
                    <span className="text-xs font-medium w-10 text-center text-corthex-text-secondary">{zoomLevel}%</span>
                    <button className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-corthex-surface text-corthex-text-secondary transition-colors" title="Zoom In">
